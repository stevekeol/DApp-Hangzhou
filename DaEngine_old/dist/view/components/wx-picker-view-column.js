...
export default !(function () {
    function _Animation(model, t, n) {
        function i(t, n, o, r) {
            if (!t || !t.cancelled) {
                ...
                a ||
                    t.cancelled ||
                    (t.id = requestAnimationFrame(i.bind(null, t, n, o, r))),
                    a && r && r(n);
            }
        }
    ...
    Spring.prototype._solve = function (e, t) {
        ...
        if (r > 0) {
            var c = (-n - Math.sqrt(r)) / (2 * i), d = (-n + Math.sqrt(r)) / (2 * i), l = (t - c * e) / (d - c), s = e - l;
            return {
                x: function (e) {
                    var t, n;
                    return (e === this._t && ((t = this._powER1T), (n = this._powER2T)),
                        (this._t = e),
                        t || (t = this._powER1T = Math.pow(Math.E, c * e)),
                        n || (n = this._powER2T = Math.pow(Math.E, d * e)),
                        s * t + l * n);
                },
                dx: function (e) {
                    var t, n;
        ...
        var u = Math.sqrt(4 * i * o - n * n) / (2 * i), a = -(n / 2 * i), s = e, l = (t - a * e) / u;
        return {
            x: function (e) {
                return (Math.pow(Math.E, a * e) * (s * Math.cos(u * e) + l * Math.sin(u * e)));
            },
            dx: function (e) {
                var t = Math.pow(Math.E, a * e), n = Math.cos(u * e), i = Math.sin(u * e);
                return t * (l * u * n - s * u * i) + a * t * (l * i + s * n);
            }
        };
    };
    Spring.prototype.x = function (e) {
        return (void 0 == e && (e = (new Date().getTime() - this._startTime) / 1e3),
    ...
    Spring.prototype.setEnd = function (e, t, n) {
        if ((n || (n = new Date().getTime()), e != this._endPosition || !i(t, s))) {
            ...
            this._solution &&
                (i(t, s) && (t = this._solution.dx((n - this._startTime) / 1e3)),
                    (o = this._solution.x((n - this._startTime) / 1e3)),
                    i(t, s) && (t = 0),
                    i(o, s) && (o = 0),
                    (o += this._endPosition)),
                (this._solution && i(o - e, s) && i(t, s)) ||
                    ((this._endPosition = e),
    ...
    Spring.prototype.done = function (e) {
        return (e || (e = new Date().getTime()),
            n(this.x(), this._endPosition, s) && i(this.dx(), s));
    };
    ...
    Scroll.prototype.x = function (e) {
        if (!this._startTime)
            return 0;
        if ((e || (e = (new Date().getTime() - this._startTime) / 1e3),
            this._springing)) {
    ...
    Handler.prototype.onTouchMove = function (e, t) {
        ...
        pos > 0
            ? (pos *= l)
            : pos < -this._extent && (pos = (pos + this._extent) * l - this._extent);
        this._position = pos;
    ...
    Handler.prototype.snap = function () {
        var height = this._itemHeight, t = this._position % height, n = Math.abs(t) > 17
    ...
    Handler.prototype.update = function (e) {
        ...
        typeof e === 'number' && (this._position = -e * this._itemHeight),
            this._position < -t
                ? (this._position = -t)
                : this._position > 0 && (this._position = 0),
            (this._element.style.transform =
                'translateY(' + this._position + 'px) translateZ(0)'),
            (this._element.style.webkitTransform =
                'translateY(' + this._position + 'px) translateZ(0)'),
            (this._extent = t),
            (this._scroll._extent = t);
    };
    ...
    window.exparser.registerElement({
        ...
        _setHeight: function (height) {
            var indicatorHeight = this.$.indicator.offsetHeight, contents = this.$.content.children, idx = 0, len = contents.length;
            for (; idx < len; idx++) {
        ...
        _init: function () {
            ...
            this._handlers.snapCallback = function (idx) {
                idx !== that._current &&
                    ((that._current = idx),
                        that.triggerEvent('wxPickerColumnValueChanged', {
                            idx: idx
                        }, {
                            bubbles: !0
                        }));
        ...
        _handleTouchEnd: function (event) {
            ...
            if (touchInfo.trackingID != -1) {
                ...
                if (delta) {
                    ...
                    var historyTimeLen = touchInfo.historyTime.length, r = {
                        x: 0,
                        y: 0
                    };
                    if (historyTimeLen > 2) {
                        var lastIdx = touchInfo.historyTime.length - 1, lastHistoryTIme = touchInfo.historyTime[lastIdx], lastHistoryX = touchInfo.historyX[lastIdx], lastHistoryY = touchInfo.historyY[lastIdx];
                        for (; lastIdx > 0;) {
                            lastIdx--;
                            var timeItem = touchInfo.historyTime[lastIdx], u = lastHistoryTIme - timeItem;
                            if (u > 30 && u < 50) {
