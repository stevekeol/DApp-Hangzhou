...
var getCanvasTouches = function (args) {
    var self = this;
...
var calcDistance = function (end, start) {
        ...
        if (actions) {
            ...
            if (flag === !1) {
                ...
                actions.forEach(function (act) {
                    ...
                    if (/^set/.test(_method)) {
                        var styleKey = _method[3].toLowerCase() + _method.slice(4), styleVal = void 0;
                        if (styleKey === 'fillStyle' || styleKey === 'strokeStyle') {
                            if (_data[0] === 'normal') {
                                ...
                                var s = _data[1][0], l = _data[1][1], c = _data[1][2], d = [s, l, 0, s, l, c], _gradient = ctx.createRadialGradient.apply(ctx, d);
                                _data[2].forEach(function (arr) {
                                    var t = arr[0], n = resolveColor(arr[1]);
                                    _gradient.addColorStop(t, n);
                                });
                        ...
                        if (_method === 'fillPath' || _method === 'strokePath') {
                            ...
                            if (_method === 'fillText') {
                                ...
                                if (_method === 'drawImage') {
                                    !(function () {
                                        var _arr = _toArray(_data), _url = _arr[0], params = _arr.slice(1);
