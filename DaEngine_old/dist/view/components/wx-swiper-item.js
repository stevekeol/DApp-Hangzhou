...
export default !(function () {
    ...
    var computePendingTime = function (ele, func) {
        ...
        var triggerFunc = function e() {
            ...
            for (var i = 0; i < pendingList.length; i++) {
                var o = pendingList[i];
                o.frames--,
                    o.frames || (o.func.call(o.self), pendingList.splice(i--, 1));
            }
    ...
    var removeFromPendingList = function (e) {
        for (var t = 0; t < pendingList.length; t++) {
            if (pendingList[t].id === e)
                return void pendingList.splice(t, 1);
        }
    };
    window.exparser.registerElement({
        ...
        detached: function () {
            ...
            this._relatedSwiper &&
                (this._relatedSwiper.triggerEvent('wxSwiperItemChanged'),
                    (this._relatedSwiper = null));
        },
        _setTransform: function (duration, transform, hasPending) {
            hasPending
                ? ((this.$$.style.transitionDuration = '0ms'),
                    (this.$$.style['-webkit-transform'] = hasPending),
                    (this.$$.style.transform = hasPending),
                    (this._pendingTransform = transform),
                    (this._pendingTimeoutId = computePendingTime(this, function () {
                        ;
        ...
        _clearTransform: function () {
            ...
            this._pendingTimeoutId &&
                ((this.$$.style['-webkit-transform'] = this._pendingTransform),
                    (this.$$.style.transform = this._pendingTransform),
                    removeFromPendingList(this._pendingTimeoutId),
                    (this._pendingTimeoutId = 0));
        }
    });
})();
