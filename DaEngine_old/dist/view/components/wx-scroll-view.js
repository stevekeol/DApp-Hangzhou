            ...
            (clearTimeout(this._timeout),
                (this._timeout = setTimeout(function () {
                    ...
                    if ((this.triggerEvent('scroll', {
                        ...
                        this.scrollY)) {
                        var goTop = this._lastScrollTop - main.scrollTop > 0, goBottom = this._lastScrollTop - main.scrollTop < 0;
                    ...
                    if (this.scrollX) {
                        var goLeft = this._lastScrollLeft - main.scrollLeft > 0, goRight = this._lastScrollLeft - main.scrollLeft < 0;
    ...
    _srollIntoViewChanged: function (id) {
        if (id) {
            if (Number(id[0]) >= 0 && Number(id[0]) <= 9) {
                return (console.group('scroll-into-view="' + id + '" 有误'),
