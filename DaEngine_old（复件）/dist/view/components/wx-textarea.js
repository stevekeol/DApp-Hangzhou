...
export default !(function () {
    window.exparser.registerElement({
        ...
        getComputedStyle: function () {
            ...
            window.requestAnimationFrame(function () {
                ...
                var lrSize = ['Left', 'Right'].map(function (side) {
                    return (parseFloat(selfStyle['border' + side + 'Width']) +
        ...
        _getComputePlaceholderStyle: function () {
            var stylecomputeEle = this.$.stylecompute, computedStyle = window.getComputedStyle(stylecomputeEle), fontWight = parseInt(computedStyle.fontWeight);
            isNaN(fontWight)
