...
// 疑问：可是template中只有index.html模板，没有service.html模板呀？？？
...
// router.post('/errorLog', body(), function * () {
//   util.logger.error(JSON.stringify(this.request.fields))
//   this.body = {
//     code: 200
//   }
//   this.type = 'json'
//   console.error(this.request.fields)
// })
