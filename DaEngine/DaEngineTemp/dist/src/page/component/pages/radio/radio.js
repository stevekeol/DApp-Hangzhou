...
var z = [];
  (function(z){
    ...
    Z([3, 'page-foot']);Z([3, 'none']);Z([3, 'switchTab']);Z([3, '/page/component/index']);Z([3, 'icon-foot']);Z([3, '../../../../image/icon_foot.png']);Z([3, 'page-head']);Z([3, 'page-head-title']);Z([a, [[7],[3, "title"]]]);Z([3, 'page-head-line']);Z([[7],[3, "desc"]]);Z([3, 'page-head-desc']);Z([3, 'container']);Z([3, 'head']);Z([[8], "title", [1, "radio"]]);Z([3, 'page-body']);Z([3, 'page-section page-section-gap']);Z([3, 'page-section-title']);Z([3, '默认样式']);Z([3, 'radio']);Z([3, 'true']);Z([3, 'r1']);Z([3, '选中\n      ']);Z([3, 'r2']);Z([3, '未选中\n      ']);Z([3, 'page-section']);Z([3, '推荐展示样式']);Z([3, 'weui-cells weui-cells_after-title']);Z([3, 'radioChange']);Z([[7],[3, "items"]]);Z([[6],[[7],[3, "item"]],[3, "value"]]);Z([3, 'weui-cell weui-check__label']);Z([3, 'weui-cell__hd']);Z([3, 'weui-cell__bd']);Z([a, [[6],[[7],[3, "item"]],[3, "name"]]]);Z([3, 'foot']);
    ...
    p_[b]=true
    try{
      var orP = _m( "navigator", ["class", 0,"hoverClass", 1,"openType", 1,"url", 2], e, s, gg);var osP = _m( "image", ["class", 4,"src", 1], e, s, gg);_(orP,osP);_(r,orP);
    }catch(err){
    p_[b]=false
    throw err
    }
  ...
  var m0=function(e,s,r,gg){
    ...
    p_[b]=true
    try{
      var owP = _n("view");_r(owP, 'class', 6, e, s, gg);var oxP = _n("view");_r(oxP, 'class', 7, e, s, gg);var oyP = _o(8, e, s, gg);_(oxP,oyP);_(owP,oxP);var ozP = _n("view");_r(ozP, 'class', 9, e, s, gg);_(owP,ozP);var o_P = _v();
      if (_o(10, e, s, gg)) {
        o_P.wxVkey = 1;var oAQ = _n("view");_r(oAQ, 'class', 11, e, s, gg);var oCQ = _o(10, e, s, gg);_(oAQ,oCQ);_(o_P, oAQ);
      } _(owP,o_P);_(r,owP);
    }catch(err){
    p_[b]=false
    throw err
  ...
  var m1=function(e,s,r,gg){
    ...
    return r;
        ...
        e_["./page/common/head.wxml"]={f:m1,j:[],i:[],ti:[],ic:[]};d_["./page/component/pages/radio/radio.wxml"] = {};
  var m2=function(e,s,r,gg){
    var oFQ = e_["./page/component/pages/radio/radio.wxml"].i;_ai(oFQ, '../../../common/head.wxml', e_, './page/component/pages/radio/radio.wxml', 0, 0);_ai(oFQ, '../../../common/foot.wxml', e_, './page/component/pages/radio/radio.wxml', 0, 0);var oIQ = _n("view");_r(oIQ, 'class', 12, e, s, gg);var oJQ = _v();
       var oKQ = _o(13, e, s, gg);
       var oMQ = _gd('./page/component/pages/radio/radio.wxml', oKQ, e_, d_);
       if (oMQ) {
         var oLQ = _1(14,e,s,gg);
         oMQ(oLQ,oLQ,oJQ, gg);
       } else _w(oKQ, './page/component/pages/radio/radio.wxml', 0, 0);_(oIQ,oJQ);var oNQ = _n("view");_r(oNQ, 'class', 15, e, s, gg);var oOQ = _n("view");_r(oOQ, 'class', 16, e, s, gg);var oPQ = _n("view");_r(oPQ, 'class', 17, e, s, gg);var oQQ = _o(18, e, s, gg);_(oPQ,oQQ);_(oOQ,oPQ);var oRQ = _n("label");_r(oRQ, 'class', 19, e, s, gg);var oSQ = _m( "radio", ["checked", 20,"value", 1], e, s, gg);_(oRQ,oSQ);var oTQ = _o(22, e, s, gg);_(oRQ,oTQ);_(oOQ,oRQ);var oUQ = _n("label");_r(oUQ, 'class', 19, e, s, gg);var oVQ = _n("radio");_r(oVQ, 'value', 23, e, s, gg);_(oUQ,oVQ);var oWQ = _o(24, e, s, gg);_(oUQ,oWQ);_(oOQ,oUQ);_(oNQ,oOQ);var oXQ = _n("view");_r(oXQ, 'class', 25, e, s, gg);var oYQ = _n("view");_r(oYQ, 'class', 17, e, s, gg);var oZQ = _o(26, e, s, gg);_(oYQ,oZQ);_(oXQ,oYQ);var oaQ = _n("view");_r(oaQ, 'class', 27, e, s, gg);var obQ = _n("radio-group");_r(obQ, 'bindchange', 28, e, s, gg);var ocQ = _v();var odQ = function(ohQ,ogQ,ofQ,gg){var oeQ = _n("label");_r(oeQ, 'class', 31, ohQ, ogQ, gg);var ojQ = _n("view");_r(ojQ, 'class', 32, ohQ, ogQ, gg);var okQ = _m( "radio", ["checked", 20,"value", 10], ohQ, ogQ, gg);_(ojQ,okQ);_(oeQ,ojQ);var olQ = _n("view");_r(olQ, 'class', 33, ohQ, ogQ, gg);var omQ = _o(34, ohQ, ogQ, gg);_(olQ,omQ);_(oeQ,olQ);_(ofQ, oeQ);return ofQ;};_2(29, odQ, e, s, gg, ocQ, "item", "index", '{{item.value}}');_(obQ,ocQ);_(oaQ,obQ);_(oXQ,oaQ);_(oNQ,oXQ);_(oIQ,oNQ);var onQ = _v();
       var ooQ = _o(35, e, s, gg);
       var oqQ = _gd('./page/component/pages/radio/radio.wxml', ooQ, e_, d_);
       if (oqQ) {
         var opQ = {};
         oqQ(opQ,opQ,onQ, gg);
       } else _w(ooQ, './page/component/pages/radio/radio.wxml', 0, 0);_(oIQ,onQ);_(r,oIQ);oFQ.pop();oFQ.pop();
    return r;
  };
        e_["./page/component/pages/radio/radio.wxml"]={f:m2,j:[],i:[],ti:["../../../common/head.wxml","../../../common/foot.wxml"],ic:[]};
if(path&&e_[path]){
...
});require("page/component/pages/radio/radio.js")@code-separator-line:["div","template","navigator","image","view","import","label","radio","radio-group"]