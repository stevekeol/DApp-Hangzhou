...
var z = [];
  (function(z){
    ...
    Z([3, 'page-foot']);Z([3, 'none']);Z([3, 'switchTab']);Z([3, '/page/component/index']);Z([3, 'icon-foot']);Z([3, '../../../../image/icon_foot.png']);Z([3, 'page-head']);Z([3, 'page-head-title']);Z([a, [[7],[3, "title"]]]);Z([3, 'page-head-line']);Z([[7],[3, "desc"]]);Z([3, 'page-head-desc']);Z([3, 'container']);Z([3, 'head']);Z([[8], "title", [1, "form"]]);Z([3, 'page-body']);Z([3, 'formReset']);Z([3, 'formSubmit']);Z([3, 'page-section page-section-gap']);Z([3, 'page-section-title']);Z([3, 'switch']);Z([3, 'radio']);Z([3, 'radio1']);Z([3, '选项一']);Z([3, 'radio2']);Z([3, '选项二']);Z([3, 'checkbox']);Z([3, 'checkbox1']);Z([3, 'checkbox2']);Z([3, 'slider']);Z([3, '50']);Z([3, 'page-section']);Z([3, 'input']);Z([3, 'weui-cells weui-cells_after-title']);Z([3, 'weui-cell weui-cell_input']);Z([3, 'weui-cell__bd']);Z([3, 'weui-input']);Z([3, '这是一个输入框']);Z([3, 'btn-area']);Z([3, 'submit']);Z([3, 'primary']);Z([3, 'Submit']);Z([3, 'reset']);Z([3, 'Reset']);Z([3, 'foot']);
    ...
    p_[b]=true
    try{
      var oRK = _m( "navigator", ["class", 0,"hoverClass", 1,"openType", 1,"url", 2], e, s, gg);var oSK = _m( "image", ["class", 4,"src", 1], e, s, gg);_(oRK,oSK);_(r,oRK);
    }catch(err){
    p_[b]=false
    throw err
    }
  ...
  var m0=function(e,s,r,gg){
    ...
    p_[b]=true
    try{
      var oWK = _n("view");_r(oWK, 'class', 6, e, s, gg);var oXK = _n("view");_r(oXK, 'class', 7, e, s, gg);var oYK = _o(8, e, s, gg);_(oXK,oYK);_(oWK,oXK);var oZK = _n("view");_r(oZK, 'class', 9, e, s, gg);_(oWK,oZK);var oaK = _v();
      if (_o(10, e, s, gg)) {
        oaK.wxVkey = 1;var obK = _n("view");_r(obK, 'class', 11, e, s, gg);var odK = _o(10, e, s, gg);_(obK,odK);_(oaK, obK);
      } _(oWK,oaK);_(r,oWK);
    }catch(err){
    p_[b]=false
    throw err
  ...
  var m1=function(e,s,r,gg){
    ...
    return r;
        ...
        e_["./page/common/head.wxml"]={f:m1,j:[],i:[],ti:[],ic:[]};d_["./page/component/pages/form/form.wxml"] = {};
  var m2=function(e,s,r,gg){
    var ogK = e_["./page/component/pages/form/form.wxml"].i;_ai(ogK, '../../../common/head.wxml', e_, './page/component/pages/form/form.wxml', 0, 0);_ai(ogK, '../../../common/foot.wxml', e_, './page/component/pages/form/form.wxml', 0, 0);var ojK = _n("view");_r(ojK, 'class', 12, e, s, gg);var okK = _v();
       var olK = _o(13, e, s, gg);
       var onK = _gd('./page/component/pages/form/form.wxml', olK, e_, d_);
       if (onK) {
         var omK = _1(14,e,s,gg);
         onK(omK,omK,okK, gg);
       } else _w(olK, './page/component/pages/form/form.wxml', 0, 0);_(ojK,okK);var ooK = _n("view");_r(ooK, 'class', 15, e, s, gg);var opK = _m( "form", ["catchreset", 16,"catchsubmit", 1], e, s, gg);var oqK = _n("view");_r(oqK, 'class', 18, e, s, gg);var orK = _n("view");_r(orK, 'class', 19, e, s, gg);var osK = _o(20, e, s, gg);_(orK,osK);_(oqK,orK);var otK = _n("switch");_r(otK, 'name', 20, e, s, gg);_(oqK,otK);_(opK,oqK);var ouK = _n("view");_r(ouK, 'class', 18, e, s, gg);var ovK = _n("view");_r(ovK, 'class', 19, e, s, gg);var owK = _o(21, e, s, gg);_(ovK,owK);_(ouK,ovK);var oxK = _n("radio-group");_r(oxK, 'name', 21, e, s, gg);var oyK = _n("label");var ozK = _n("radio");_r(ozK, 'value', 22, e, s, gg);_(oyK,ozK);var o_K = _o(23, e, s, gg);_(oyK,o_K);_(oxK,oyK);var oAL = _n("label");var oBL = _n("radio");_r(oBL, 'value', 24, e, s, gg);_(oAL,oBL);var oCL = _o(25, e, s, gg);_(oAL,oCL);_(oxK,oAL);_(ouK,oxK);_(opK,ouK);var oDL = _n("view");_r(oDL, 'class', 18, e, s, gg);var oEL = _n("view");_r(oEL, 'class', 19, e, s, gg);var oFL = _o(26, e, s, gg);_(oEL,oFL);_(oDL,oEL);var oGL = _n("checkbox-group");_r(oGL, 'name', 26, e, s, gg);var oHL = _n("label");var oIL = _n("checkbox");_r(oIL, 'value', 27, e, s, gg);_(oHL,oIL);var oJL = _o(23, e, s, gg);_(oHL,oJL);_(oGL,oHL);var oKL = _n("label");var oLL = _n("checkbox");_r(oLL, 'value', 28, e, s, gg);_(oKL,oLL);var oML = _o(25, e, s, gg);_(oKL,oML);_(oGL,oKL);_(oDL,oGL);_(opK,oDL);var oNL = _n("view");_r(oNL, 'class', 18, e, s, gg);var oOL = _n("view");_r(oOL, 'class', 19, e, s, gg);var oPL = _o(29, e, s, gg);_(oOL,oPL);_(oNL,oOL);var oQL = _m( "slider", ["showValue", -1,"name", 29,"value", 1], e, s, gg);_(oNL,oQL);_(opK,oNL);var oRL = _n("view");_r(oRL, 'class', 31, e, s, gg);var oSL = _n("view");_r(oSL, 'class', 19, e, s, gg);var oTL = _o(32, e, s, gg);_(oSL,oTL);_(oRL,oSL);var oUL = _n("view");_r(oUL, 'class', 33, e, s, gg);var oVL = _n("view");_r(oVL, 'class', 34, e, s, gg);var oWL = _n("view");_r(oWL, 'class', 35, e, s, gg);var oXL = _m( "input", ["name", 32,"class", 4,"placeholder", 5], e, s, gg);_(oWL,oXL);_(oVL,oWL);_(oUL,oVL);_(oRL,oUL);_(opK,oRL);var oYL = _n("view");_r(oYL, 'class', 38, e, s, gg);var oZL = _m( "button", ["formType", 39,"type", 1], e, s, gg);var oaL = _o(41, e, s, gg);_(oZL,oaL);_(oYL,oZL);var obL = _n("button");_r(obL, 'formType', 42, e, s, gg);var ocL = _o(43, e, s, gg);_(obL,ocL);_(oYL,obL);_(opK,oYL);_(ooK,opK);_(ojK,ooK);var odL = _v();
       var oeL = _o(44, e, s, gg);
       var ogL = _gd('./page/component/pages/form/form.wxml', oeL, e_, d_);
       if (ogL) {
         var ofL = {};
         ogL(ofL,ofL,odL, gg);
       } else _w(oeL, './page/component/pages/form/form.wxml', 0, 0);_(ojK,odL);_(r,ojK);ogK.pop();ogK.pop();
    return r;
  };
        e_["./page/component/pages/form/form.wxml"]={f:m2,j:[],i:[],ti:["../../../common/head.wxml","../../../common/foot.wxml"],ic:[]};
if(path&&e_[path]){
...
});require("page/component/pages/form/form.js")@code-separator-line:["div","template","navigator","image","view","import","form","switch","radio-group","label","radio","checkbox-group","checkbox","slider","input","button"]