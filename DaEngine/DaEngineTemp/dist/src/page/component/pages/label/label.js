...
var z = [];
  (function(z){
    ...
    Z([3, 'page-foot']);Z([3, 'none']);Z([3, 'switchTab']);Z([3, '/page/component/index']);Z([3, 'icon-foot']);Z([3, '../../../../image/icon_foot.png']);Z([3, 'page-head']);Z([3, 'page-head-title']);Z([a, [[7],[3, "title"]]]);Z([3, 'page-head-line']);Z([[7],[3, "desc"]]);Z([3, 'page-head-desc']);Z([3, 'container']);Z([3, 'head']);Z([[8], "title", [1, "label"]]);Z([3, 'page-body']);Z([3, 'page-section page-section-gap']);Z([3, 'page-section-title']);Z([3, '表单组件在label内']);Z([3, 'checkboxChange']);Z([3, 'group']);Z([[7],[3, "checkboxItems"]]);Z([3, 'label-1']);Z([[6],[[7],[3, "item"]],[3, "checked"]]);Z([[6],[[7],[3, "item"]],[3, "name"]]);Z([3, 'label-1-text']);Z([a, [[6],[[7],[3, "item"]],[3, "value"]]]);Z([3, 'label用for标识表单组件']);Z([3, 'radioChange']);Z([[7],[3, "radioItems"]]);Z([3, 'label-2']);Z([3, 'label-2-text']);Z([3, 'label内有多个时选中第一个']);Z([3, 'label-3']);Z([3, 'checkbox-3']);Z([3, '选项一']);Z([3, '选项二']);Z([3, 'label-3-text']);Z([3, '点击该label下的文字默认选中第一个checkbox']);Z([3, 'foot']);
...
if(typeof(window.__webview_engine_version__)=='undefined'||window.__webview_engine_version__+1e-6<0.01+1e-6){return _ev(root);}}catch(err){console.log(err)}return root;}}}@code-separator-line:.label-1,.label-2{margin:%%?30rpx?%% 0}.label-3-text{color:#576b95;font-size:%%?28rpx?%%}.checkbox-3{display:block;margin:%%?30rpx?%% 0}@code-separator-line:__wxRoute = "page/component/pages/label/label";__wxRouteBegin = true;
define("page/component/pages/label/label.js", function(require, module, exports, window,document,frames,self,location,navigator,localStorage,history,Caches,screen,alert,confirm,prompt,fetch,XMLHttpRequest,WebSocket,webkit,WeixinJSCore,ServiceJSBridge,Reporter){
'use strict';
...
});require("page/component/pages/label/label.js")@code-separator-line:["div","template","navigator","image","view","import","checkbox-group","label","checkbox","text","radio-group","radio"]