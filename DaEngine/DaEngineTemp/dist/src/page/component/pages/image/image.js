...
var z = [];
  (function(z){
    ...
    Z([3, 'page-foot']);Z([3, 'none']);Z([3, 'switchTab']);Z([3, '/page/component/index']);Z([3, 'icon-foot']);Z([3, '../../../../image/icon_foot.png']);Z([3, 'page-head']);Z([3, 'page-head-title']);Z([a, [[7],[3, "title"]]]);Z([3, 'page-head-line']);Z([[7],[3, "desc"]]);Z([3, 'page-head-desc']);Z([3, 'container']);Z([3, 'head']);Z([[8], "title", [1, "image"]]);Z([3, 'page-body']);Z([3, 'page-section page-section-gap']);Z([3, 'page-section-title']);Z([3, 'Local Image']);Z([3, 'page-section-ctn']);Z([3, 'image']);Z([3, '../../resources/pic/1.jpg']);Z([3, 'Internet Image']);Z([3, '../../resources/pic/2.jpg']);Z([3, 'foot']);
...
if(typeof(window.__webview_engine_version__)=='undefined'||window.__webview_engine_version__+1e-6<0.01+1e-6){return _ev(root);}}catch(err){console.log(err)}return root;}}}@code-separator-line:.page-section-ctn{text-align:center}.image{margin-top:%%?30rpx?%%;width:%%?580rpx?%%;height:%%?208rpx?%%}@code-separator-line:__wxRoute = "page/component/pages/image/image";__wxRouteBegin = true;
define("page/component/pages/image/image.js", function(require, module, exports, window,document,frames,self,location,navigator,localStorage,history,Caches,screen,alert,confirm,prompt,fetch,XMLHttpRequest,WebSocket,webkit,WeixinJSCore,ServiceJSBridge,Reporter){
"use strict";

Page({});
});require("page/component/pages/image/image.js")@code-separator-line:["div","template","navigator","image","view","import"]