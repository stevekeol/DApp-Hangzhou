...
var z = [];
  (function(z){
    ...
    Z([3, 'page-foot']);Z([3, 'none']);Z([3, 'switchTab']);Z([3, '/page/component/index']);Z([3, 'icon-foot']);Z([3, '../../../../image/icon_foot.png']);Z([3, 'page-head']);Z([3, 'page-head-title']);Z([a, [[7],[3, "title"]]]);Z([3, 'page-head-line']);Z([[7],[3, "desc"]]);Z([3, 'page-head-desc']);Z([3, 'container']);Z([3, 'head']);Z([[8], "title", [1, "swiper"]]);Z([3, 'page-body']);Z([3, 'page-section page-section-spacing swiper']);Z([[7],[3, "autoplay"]]);Z([[7],[3, "duration"]]);Z([[7],[3, "indicatorDots"]]);Z([[7],[3, "interval"]]);Z([[7],[3, "background"]]);Z([3, '*this']);Z([a, [3, 'swiper-item '],[[7],[3, "item"]]]);Z([3, 'page-section']);Z([3, 'margin-top: 40rpx;margin-bottom: 0;']);Z([3, 'weui-cells weui-cells_after-title']);Z([3, 'weui-cell weui-cell_switch']);Z([3, 'weui-cell__bd']);Z([3, '指示点']);Z([3, 'weui-cell__ft']);Z([3, 'changeIndicatorDots']);Z([3, '自动播放']);Z([3, 'changeAutoplay']);Z([3, 'page-section page-section-spacing']);Z([3, 'page-section-title']);Z([3, '幻灯片切换时长(ms)']);Z([3, 'info']);Z([3, 'durationChange']);Z([3, '2000']);Z([3, '500']);Z([3, '自动播放间隔时长(ms)']);Z([3, 'intervalChange']);Z([3, '10000']);Z([3, 'foot']);
    ...
    p_[b]=true
    try{
      var oHD = _m( "navigator", ["class", 0,"hoverClass", 1,"openType", 1,"url", 2], e, s, gg);var oID = _m( "image", ["class", 4,"src", 1], e, s, gg);_(oHD,oID);_(r,oHD);
    }catch(err){
    p_[b]=false
    throw err
    }
  ...
  var m0=function(e,s,r,gg){
    ...
    p_[b]=true
    try{
      var oMD = _n("view");_r(oMD, 'class', 6, e, s, gg);var oND = _n("view");_r(oND, 'class', 7, e, s, gg);var oOD = _o(8, e, s, gg);_(oND,oOD);_(oMD,oND);var oPD = _n("view");_r(oPD, 'class', 9, e, s, gg);_(oMD,oPD);var oQD = _v();
      if (_o(10, e, s, gg)) {
        oQD.wxVkey = 1;var oRD = _n("view");_r(oRD, 'class', 11, e, s, gg);var oTD = _o(10, e, s, gg);_(oRD,oTD);_(oQD, oRD);
      } _(oMD,oQD);_(r,oMD);
    }catch(err){
    p_[b]=false
    throw err
  ...
  var m1=function(e,s,r,gg){
    ...
    return r;
        ...
        e_["./page/common/head.wxml"]={f:m1,j:[],i:[],ti:[],ic:[]};d_["./page/component/pages/swiper/swiper.wxml"] = {};
  var m2=function(e,s,r,gg){
    var oWD = e_["./page/component/pages/swiper/swiper.wxml"].i;_ai(oWD, '../../../common/head.wxml', e_, './page/component/pages/swiper/swiper.wxml', 0, 0);_ai(oWD, '../../../common/foot.wxml', e_, './page/component/pages/swiper/swiper.wxml', 0, 0);var oZD = _n("view");_r(oZD, 'class', 12, e, s, gg);var oaD = _v();
       var obD = _o(13, e, s, gg);
       var odD = _gd('./page/component/pages/swiper/swiper.wxml', obD, e_, d_);
       if (odD) {
         var ocD = _1(14,e,s,gg);
         odD(ocD,ocD,oaD, gg);
       } else _w(obD, './page/component/pages/swiper/swiper.wxml', 0, 0);_(oZD,oaD);var oeD = _n("view");_r(oeD, 'class', 15, e, s, gg);var ofD = _n("view");_r(ofD, 'class', 16, e, s, gg);var ogD = _m( "swiper", ["autoplay", 17,"duration", 1,"indicatorDots", 2,"interval", 3], e, s, gg);var ohD = _v();var oiD = function(omD,olD,okD,gg){var ooD = _n("swiper-item");var opD = _n("view");_r(opD, 'class', 23, omD, olD, gg);_(ooD,opD);_(okD,ooD);return okD;};_2(21, oiD, e, s, gg, ohD, "item", "index", '*this');_(ogD,ohD);_(ofD,ogD);_(oeD,ofD);var oqD = _m( "view", ["class", 24,"style", 1], e, s, gg);var orD = _n("view");_r(orD, 'class', 26, e, s, gg);var osD = _n("view");_r(osD, 'class', 27, e, s, gg);var otD = _n("view");_r(otD, 'class', 28, e, s, gg);var ouD = _o(29, e, s, gg);_(otD,ouD);_(osD,otD);var ovD = _n("view");_r(ovD, 'class', 30, e, s, gg);var owD = _m( "switch", ["checked", 19,"bindchange", 12], e, s, gg);_(ovD,owD);_(osD,ovD);_(orD,osD);var oxD = _n("view");_r(oxD, 'class', 27, e, s, gg);var oyD = _n("view");_r(oyD, 'class', 28, e, s, gg);var ozD = _o(32, e, s, gg);_(oyD,ozD);_(oxD,oyD);var o_D = _n("view");_r(o_D, 'class', 30, e, s, gg);var oAE = _m( "switch", ["checked", 17,"bindchange", 16], e, s, gg);_(o_D,oAE);_(oxD,o_D);_(orD,oxD);_(oqD,orD);_(oeD,oqD);var oBE = _n("view");_r(oBE, 'class', 34, e, s, gg);var oCE = _n("view");_r(oCE, 'class', 35, e, s, gg);var oDE = _n("text");var oEE = _o(36, e, s, gg);_(oDE,oEE);_(oCE,oDE);var oFE = _n("text");_r(oFE, 'class', 37, e, s, gg);var oGE = _o(18, e, s, gg);_(oFE,oGE);_(oCE,oFE);_(oBE,oCE);var oHE = _m( "slider", ["value", 18,"bindchange", 20,"max", 21,"min", 22], e, s, gg);_(oBE,oHE);var oIE = _n("view");_r(oIE, 'class', 35, e, s, gg);var oJE = _n("text");var oKE = _o(41, e, s, gg);_(oJE,oKE);_(oIE,oJE);var oLE = _n("text");_r(oLE, 'class', 37, e, s, gg);var oME = _o(20, e, s, gg);_(oLE,oME);_(oIE,oLE);_(oBE,oIE);var oNE = _m( "slider", ["value", 20,"min", 19,"bindchange", 22,"max", 23], e, s, gg);_(oBE,oNE);_(oeD,oBE);_(oZD,oeD);var oOE = _v();
       var oPE = _o(44, e, s, gg);
       var oRE = _gd('./page/component/pages/swiper/swiper.wxml', oPE, e_, d_);
       if (oRE) {
         var oQE = {};
         oRE(oQE,oQE,oOE, gg);
       } else _w(oPE, './page/component/pages/swiper/swiper.wxml', 0, 0);_(oZD,oOE);_(r,oZD);oWD.pop();oWD.pop();
    return r;
  };
        e_["./page/component/pages/swiper/swiper.wxml"]={f:m2,j:[],i:[],ti:["../../../common/head.wxml","../../../common/foot.wxml"],ic:[]};
if(path&&e_[path]){
...
});require("page/component/pages/swiper/swiper.js")@code-separator-line:["div","template","navigator","image","view","import","swiper","block","swiper-item","switch","text","slider"]