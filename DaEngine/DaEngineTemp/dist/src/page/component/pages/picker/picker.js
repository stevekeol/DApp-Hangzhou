...
var z = [];
  (function(z){
    ...
    Z([3, 'page-foot']);Z([3, 'none']);Z([3, 'switchTab']);Z([3, '/page/component/index']);Z([3, 'icon-foot']);Z([3, '../../../../image/icon_foot.png']);Z([3, 'page-head']);Z([3, 'page-head-title']);Z([a, [[7],[3, "title"]]]);Z([3, 'page-head-line']);Z([[7],[3, "desc"]]);Z([3, 'page-head-desc']);Z([3, 'container']);Z([3, 'head']);Z([[8], "title", [1, "picker"]]);Z([3, 'page-body']);Z([3, 'page-section']);Z([3, 'weui-cells__title']);Z([3, '地区选择器']);Z([3, 'weui-cells weui-cells_after-title']);Z([3, 'weui-cell weui-cell_input']);Z([3, 'weui-cell__hd']);Z([3, 'weui-label']);Z([3, '当前选择']);Z([3, 'weui-cell__bd']);Z([3, 'onStateChange']);Z([[7],[3, "array"]]);Z([[7],[3, "index"]]);Z([3, 'weui-input']);Z([a, [[6],[[7],[3, "array"]],[[7],[3, "index"]]]]);Z([3, '时间选择器']);Z([3, 'onTimeChange']);Z([3, '21:01']);Z([3, 'time']);Z([3, '09:01']);Z([[7],[3, "time"]]);Z([3, '日期选择器']);Z([3, 'onDateChange']);Z([3, '2017-09-01']);Z([3, 'date']);Z([3, '2015-09-01']);Z([[7],[3, "date"]]);Z([3, 'foot']);
...
});require("page/component/pages/picker/picker.js")@code-separator-line:["div","template","navigator","image","view","import","picker"]