...
var z = [];
  (function(z){
    ...
    Z([3, 'page-foot']);Z([3, 'none']);Z([3, 'switchTab']);Z([3, '/page/component/index']);Z([3, 'icon-foot']);Z([3, '../../../../image/icon_foot.png']);Z([3, 'page-head']);Z([3, 'page-head-title']);Z([a, [[7],[3, "title"]]]);Z([3, 'page-head-line']);Z([[7],[3, "desc"]]);Z([3, 'page-head-desc']);Z([3, 'container']);Z([3, 'head']);Z([[8], "title", [1, "input"]]);Z([3, 'page-body']);Z([3, 'page-section']);Z([3, 'weui-cells__title']);Z([3, '可以自动聚焦的input']);Z([3, 'weui-cells weui-cells_after-title']);Z([3, 'weui-cell weui-cell_input']);Z([3, 'weui-input']);Z([3, '将会获取焦点']);Z([3, '控制最大输入长度的input']);Z([3, '10']);Z([3, '最大输入长度为10']);Z([a, [3, '实时获取输入值：'],[[7],[3, "inputValue"]]]);Z([3, 'bindKeyInput']);Z([3, '输入同步到view中']);Z([3, '控制输入的input']);Z([3, 'bindReplaceInput']);Z([3, '连续的两个1会变成2']);Z([3, '控制键盘的input']);Z([3, 'bindHideKeyboard']);Z([3, '输入123自动收起键盘']);Z([3, '数字输入的input']);Z([3, '这是一个数字输入框']);Z([3, 'number']);Z([3, '密码输入的input']);Z([3, '这是一个密码输入框']);Z([3, 'text']);Z([3, '带小数点的input']);Z([3, '带小数点的数字键盘']);Z([3, 'digit']);Z([3, '身份证输入的input']);Z([3, '身份证输入键盘']);Z([3, 'idcard']);Z([3, '控制占位符颜色的input']);Z([3, '占位符字体是红色的']);Z([3, 'color:#F76260']);Z([3, 'foot']);
    ...
    p_[b]=true
    try{
      var oiL = _m( "navigator", ["class", 0,"hoverClass", 1,"openType", 1,"url", 2], e, s, gg);var ojL = _m( "image", ["class", 4,"src", 1], e, s, gg);_(oiL,ojL);_(r,oiL);
    }catch(err){
    p_[b]=false
    throw err
    }
  ...
  var m0=function(e,s,r,gg){
    ...
    p_[b]=true
    try{
      var onL = _n("view");_r(onL, 'class', 6, e, s, gg);var ooL = _n("view");_r(ooL, 'class', 7, e, s, gg);var opL = _o(8, e, s, gg);_(ooL,opL);_(onL,ooL);var oqL = _n("view");_r(oqL, 'class', 9, e, s, gg);_(onL,oqL);var orL = _v();
      if (_o(10, e, s, gg)) {
        orL.wxVkey = 1;var osL = _n("view");_r(osL, 'class', 11, e, s, gg);var ouL = _o(10, e, s, gg);_(osL,ouL);_(orL, osL);
      } _(onL,orL);_(r,onL);
    }catch(err){
    p_[b]=false
    throw err
  ...
  var m1=function(e,s,r,gg){
    ...
    return r;
        ...
        e_["./page/common/head.wxml"]={f:m1,j:[],i:[],ti:[],ic:[]};d_["./page/component/pages/input/input.wxml"] = {};
  var m2=function(e,s,r,gg){
    var oxL = e_["./page/component/pages/input/input.wxml"].i;_ai(oxL, '../../../common/head.wxml', e_, './page/component/pages/input/input.wxml', 0, 0);_ai(oxL, '../../../common/foot.wxml', e_, './page/component/pages/input/input.wxml', 0, 0);var o_L = _n("view");_r(o_L, 'class', 12, e, s, gg);var oAM = _v();
       var oBM = _o(13, e, s, gg);
       var oDM = _gd('./page/component/pages/input/input.wxml', oBM, e_, d_);
       if (oDM) {
         var oCM = _1(14,e,s,gg);
         oDM(oCM,oCM,oAM, gg);
       } else _w(oBM, './page/component/pages/input/input.wxml', 0, 0);_(o_L,oAM);var oEM = _n("view");_r(oEM, 'class', 15, e, s, gg);var oFM = _n("view");_r(oFM, 'class', 16, e, s, gg);var oGM = _n("view");_r(oGM, 'class', 17, e, s, gg);var oHM = _o(18, e, s, gg);_(oGM,oHM);_(oFM,oGM);var oIM = _n("view");_r(oIM, 'class', 19, e, s, gg);var oJM = _n("view");_r(oJM, 'class', 20, e, s, gg);var oKM = _m( "input", ["autoFocus", -1,"class", 21,"placeholder", 1], e, s, gg);_(oJM,oKM);_(oIM,oJM);_(oFM,oIM);_(oEM,oFM);var oLM = _n("view");_r(oLM, 'class', 16, e, s, gg);var oMM = _n("view");_r(oMM, 'class', 17, e, s, gg);var oNM = _o(23, e, s, gg);_(oMM,oNM);_(oLM,oMM);var oOM = _n("view");_r(oOM, 'class', 19, e, s, gg);var oPM = _n("view");_r(oPM, 'class', 20, e, s, gg);var oQM = _m( "input", ["class", 21,"maxlength", 3,"placeholder", 4], e, s, gg);_(oPM,oQM);_(oOM,oPM);_(oLM,oOM);_(oEM,oLM);var oRM = _n("view");_r(oRM, 'class', 16, e, s, gg);var oSM = _n("view");_r(oSM, 'class', 17, e, s, gg);var oTM = _o(26, e, s, gg);_(oSM,oTM);_(oRM,oSM);var oUM = _n("view");_r(oUM, 'class', 19, e, s, gg);var oVM = _n("view");_r(oVM, 'class', 20, e, s, gg);var oWM = _m( "input", ["class", 21,"maxlength", 3,"bindinput", 6,"placeholder", 7], e, s, gg);_(oVM,oWM);_(oUM,oVM);_(oRM,oUM);_(oEM,oRM);var oXM = _n("view");_r(oXM, 'class', 16, e, s, gg);var oYM = _n("view");_r(oYM, 'class', 17, e, s, gg);var oZM = _o(29, e, s, gg);_(oYM,oZM);_(oXM,oYM);var oaM = _n("view");_r(oaM, 'class', 19, e, s, gg);var obM = _n("view");_r(obM, 'class', 20, e, s, gg);var ocM = _m( "input", ["class", 21,"bindinput", 9,"placeholder", 10], e, s, gg);_(obM,ocM);_(oaM,obM);_(oXM,oaM);_(oEM,oXM);var odM = _n("view");_r(odM, 'class', 16, e, s, gg);var oeM = _n("view");_r(oeM, 'class', 17, e, s, gg);var ofM = _o(32, e, s, gg);_(oeM,ofM);_(odM,oeM);var ogM = _n("view");_r(ogM, 'class', 19, e, s, gg);var ohM = _n("view");_r(ohM, 'class', 20, e, s, gg);var oiM = _m( "input", ["class", 21,"bindinput", 12,"placeholder", 13], e, s, gg);_(ohM,oiM);_(ogM,ohM);_(odM,ogM);_(oEM,odM);var ojM = _n("view");_r(ojM, 'class', 16, e, s, gg);var okM = _n("view");_r(okM, 'class', 17, e, s, gg);var olM = _o(35, e, s, gg);_(okM,olM);_(ojM,okM);var omM = _n("view");_r(omM, 'class', 19, e, s, gg);var onM = _n("view");_r(onM, 'class', 20, e, s, gg);var ooM = _m( "input", ["class", 21,"placeholder", 15,"type", 16], e, s, gg);_(onM,ooM);_(omM,onM);_(ojM,omM);_(oEM,ojM);var opM = _n("view");_r(opM, 'class', 16, e, s, gg);var oqM = _n("view");_r(oqM, 'class', 17, e, s, gg);var orM = _o(38, e, s, gg);_(oqM,orM);_(opM,oqM);var osM = _n("view");_r(osM, 'class', 19, e, s, gg);var otM = _n("view");_r(otM, 'class', 20, e, s, gg);var ouM = _m( "input", ["password", -1,"class", 21,"placeholder", 18,"type", 19], e, s, gg);_(otM,ouM);_(osM,otM);_(opM,osM);_(oEM,opM);var ovM = _n("view");_r(ovM, 'class', 16, e, s, gg);var owM = _n("view");_r(owM, 'class', 17, e, s, gg);var oxM = _o(41, e, s, gg);_(owM,oxM);_(ovM,owM);var oyM = _n("view");_r(oyM, 'class', 19, e, s, gg);var ozM = _n("view");_r(ozM, 'class', 20, e, s, gg);var o_M = _m( "input", ["class", 21,"placeholder", 21,"type", 22], e, s, gg);_(ozM,o_M);_(oyM,ozM);_(ovM,oyM);_(oEM,ovM);var oAN = _n("view");_r(oAN, 'class', 16, e, s, gg);var oBN = _n("view");_r(oBN, 'class', 17, e, s, gg);var oCN = _o(44, e, s, gg);_(oBN,oCN);_(oAN,oBN);var oDN = _n("view");_r(oDN, 'class', 19, e, s, gg);var oEN = _n("view");_r(oEN, 'class', 20, e, s, gg);var oFN = _m( "input", ["class", 21,"placeholder", 24,"type", 25], e, s, gg);_(oEN,oFN);_(oDN,oEN);_(oAN,oDN);_(oEM,oAN);var oGN = _n("view");_r(oGN, 'class', 16, e, s, gg);var oHN = _n("view");_r(oHN, 'class', 17, e, s, gg);var oIN = _o(47, e, s, gg);_(oHN,oIN);_(oGN,oHN);var oJN = _n("view");_r(oJN, 'class', 19, e, s, gg);var oKN = _n("view");_r(oKN, 'class', 20, e, s, gg);var oLN = _m( "input", ["class", 21,"placeholder", 27,"placeholderStyle", 28], e, s, gg);_(oKN,oLN);_(oJN,oKN);_(oGN,oJN);_(oEM,oGN);_(o_L,oEM);var oMN = _v();
       var oNN = _o(50, e, s, gg);
       var oPN = _gd('./page/component/pages/input/input.wxml', oNN, e_, d_);
       if (oPN) {
         var oON = {};
         oPN(oON,oON,oMN, gg);
       } else _w(oNN, './page/component/pages/input/input.wxml', 0, 0);_(o_L,oMN);_(r,o_L);oxL.pop();oxL.pop();
    return r;
  };
        e_["./page/component/pages/input/input.wxml"]={f:m2,j:[],i:[],ti:["../../../common/head.wxml","../../../common/foot.wxml"],ic:[]};
if(path&&e_[path]){
...
});require("page/component/pages/input/input.js")@code-separator-line:["div","template","navigator","image","view","import","input"]