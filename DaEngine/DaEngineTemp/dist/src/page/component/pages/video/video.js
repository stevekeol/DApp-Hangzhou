...
var z = [];
  (function(z){
    ...
    Z([3, 'page-foot']);Z([3, 'none']);Z([3, 'switchTab']);Z([3, '/page/component/index']);Z([3, 'icon-foot']);Z([3, '../../../../image/icon_foot.png']);Z([3, 'page-head']);Z([3, 'page-head-title']);Z([a, [[7],[3, "title"]]]);Z([3, 'page-head-line']);Z([[7],[3, "desc"]]);Z([3, 'page-head-desc']);Z([3, 'container']);Z([3, 'head']);Z([[8], "title", [1, "video"]]);Z([3, 'page-body']);Z([3, 'page-section tc']);Z([3, 'videoErrorCallback']);Z([[7],[3, "danmuList"]]);Z([3, 'myVideo']);Z([3, 'http://wxsnsdy.tc.qq.com/105/20210/snsdyvideodownload?filekey\x3d30280201010421301f0201690402534804102ca905ce620b1241b726bc41dcff44e00204012882540400\x26bizid\x3d1023\x26hy\x3dSH\x26fileparam\x3d302c020101042530230204136ffd93020457e3c4ff02024ef202031e8d7f02030f42400204045a320a0201000400']);Z([3, 'weui-cells']);Z([3, 'weui-cell weui-cell_input']);Z([3, 'weui-cell__hd']);Z([3, 'weui-label']);Z([3, '弹幕内容']);Z([3, 'weui-cell__bd']);Z([3, 'bindInputBlur']);Z([3, 'weui-input']);Z([3, '在此处输入弹幕内容']);Z([3, 'text']);Z([3, 'btn-area']);Z([3, 'bindSendDanmu']);Z([3, 'page-body-button']);Z([3, 'submit']);Z([3, 'primary']);Z([3, '发送弹幕']);Z([3, 'foot']);
    ...
    p_[b]=true
    try{
      var oiV = _m( "navigator", ["class", 0,"hoverClass", 1,"openType", 1,"url", 2], e, s, gg);var ojV = _m( "image", ["class", 4,"src", 1], e, s, gg);_(oiV,ojV);_(r,oiV);
    }catch(err){
    p_[b]=false
    throw err
    }
  ...
  var m0=function(e,s,r,gg){
    ...
    p_[b]=true
    try{
      var onV = _n("view");_r(onV, 'class', 6, e, s, gg);var ooV = _n("view");_r(ooV, 'class', 7, e, s, gg);var opV = _o(8, e, s, gg);_(ooV,opV);_(onV,ooV);var oqV = _n("view");_r(oqV, 'class', 9, e, s, gg);_(onV,oqV);var orV = _v();
      if (_o(10, e, s, gg)) {
        orV.wxVkey = 1;var osV = _n("view");_r(osV, 'class', 11, e, s, gg);var ouV = _o(10, e, s, gg);_(osV,ouV);_(orV, osV);
      } _(onV,orV);_(r,onV);
    }catch(err){
    p_[b]=false
    throw err
  ...
  var m1=function(e,s,r,gg){
    ...
    return r;
        ...
        e_["./page/common/head.wxml"]={f:m1,j:[],i:[],ti:[],ic:[]};d_["./page/component/pages/video/video.wxml"] = {};
  var m2=function(e,s,r,gg){
    var oxV = e_["./page/component/pages/video/video.wxml"].i;_ai(oxV, '../../../common/head.wxml', e_, './page/component/pages/video/video.wxml', 0, 0);_ai(oxV, '../../../common/foot.wxml', e_, './page/component/pages/video/video.wxml', 0, 0);var o_V = _n("view");_r(o_V, 'class', 12, e, s, gg);var oAW = _v();
       var oBW = _o(13, e, s, gg);
       var oDW = _gd('./page/component/pages/video/video.wxml', oBW, e_, d_);
       if (oDW) {
         var oCW = _1(14,e,s,gg);
         oDW(oCW,oCW,oAW, gg);
       } else _w(oBW, './page/component/pages/video/video.wxml', 0, 0);_(o_V,oAW);var oEW = _n("view");_r(oEW, 'class', 15, e, s, gg);var oFW = _n("view");_r(oFW, 'class', 16, e, s, gg);var oGW = _m( "video", ["controls", -1,"danmuBtn", -1,"enableDanmu", -1,"binderror", 17,"danmuList", 1,"id", 2,"src", 3], e, s, gg);_(oFW,oGW);var oHW = _n("view");_r(oHW, 'class', 21, e, s, gg);var oIW = _n("view");_r(oIW, 'class', 22, e, s, gg);var oJW = _n("view");_r(oJW, 'class', 23, e, s, gg);var oKW = _n("view");_r(oKW, 'class', 24, e, s, gg);var oLW = _o(25, e, s, gg);_(oKW,oLW);_(oJW,oKW);_(oIW,oJW);var oMW = _n("view");_r(oMW, 'class', 26, e, s, gg);var oNW = _m( "input", ["bindblur", 27,"class", 1,"placeholder", 2,"type", 3], e, s, gg);_(oMW,oNW);_(oIW,oMW);_(oHW,oIW);_(oFW,oHW);var oOW = _n("view");_r(oOW, 'class', 31, e, s, gg);var oPW = _m( "button", ["bindtap", 32,"class", 1,"formType", 2,"type", 3], e, s, gg);var oQW = _o(36, e, s, gg);_(oPW,oQW);_(oOW,oPW);_(oFW,oOW);_(oEW,oFW);_(o_V,oEW);var oRW = _v();
       var oSW = _o(37, e, s, gg);
       var oUW = _gd('./page/component/pages/video/video.wxml', oSW, e_, d_);
       if (oUW) {
         var oTW = {};
         oUW(oTW,oTW,oRW, gg);
       } else _w(oSW, './page/component/pages/video/video.wxml', 0, 0);_(o_V,oRW);_(r,o_V);oxV.pop();oxV.pop();
    return r;
  };
        e_["./page/component/pages/video/video.wxml"]={f:m2,j:[],i:[],ti:["../../../common/head.wxml","../../../common/foot.wxml"],ic:[]};
if(path&&e_[path]){
...
});require("page/component/pages/video/video.js")@code-separator-line:["div","template","navigator","image","view","import","video","input","button"]