...
var z = [];
  (function(z){
    ...
    Z([3, 'page-foot']);Z([3, 'none']);Z([3, 'switchTab']);Z([3, '/page/component/index']);Z([3, 'icon-foot']);Z([3, '../../../../image/icon_foot.png']);Z([3, 'page-head']);Z([3, 'page-head-title']);Z([a, [[7],[3, "title"]]]);Z([3, 'page-head-line']);Z([[7],[3, "desc"]]);Z([3, 'page-head-desc']);Z([3, 'container']);Z([3, 'head']);Z([[8], "title", [1, "switch"]]);Z([3, 'page-body']);Z([3, 'page-section page-section-gap']);Z([3, 'page-section-title']);Z([3, '默认样式']);Z([3, 'body-view']);Z([3, 'switch1Change']);Z([3, 'switch2Change']);Z([3, 'page-section']);Z([3, '推荐展示样式']);Z([3, 'weui-cells weui-cells_after-title']);Z([3, 'weui-cell weui-cell_switch']);Z([3, 'weui-cell__bd']);Z([3, '开启中']);Z([3, 'weui-cell__ft']);Z([3, '关闭']);Z([3, 'foot']);
...
});require("page/component/pages/switch/switch.js")@code-separator-line:["div","template","navigator","image","view","import","switch"]