...
var z = [];
  (function(z){
    ...
    Z([3, 'index']);Z([3, 'index-hd']);Z([3, 'index-desc']);Z([3, '以下将展示小程序官方组件能力，组件样式仅供参考，开发者可根据自身需求自定义组件样式，具体属性参数详见小程序开发文档。']);Z([3, 'index-bd']);Z([3, 'kind-list']);Z([[7],[3, "list"]]);Z([[6],[[7],[3, "item"]],[3, "id"]]);Z([3, 'kind-list-item']);Z([3, 'kindToggle']);Z([a, [3, 'kind-list-item-hd '],[[2,'?:'],[[6],[[7],[3, "item"]],[3, "open"]],[1, "kind-list-item-hd-show"],[1, ""]]]);Z([3, 'kind-list-text']);Z([a, [[6],[[7],[3, "item"]],[3, "name"]]]);Z([3, 'kind-list-img']);Z([a, [3, 'resources/kind/'],[[6],[[7],[3, "item"]],[3, "id"]],[3, '.png']]);Z([a, [3, 'kind-list-item-bd '],[[2,'?:'],[[6],[[7],[3, "item"]],[3, "open"]],[1, "kind-list-item-bd-show"],[1, ""]]]);Z([a, [3, 'navigator-box '],[[2,'?:'],[[6],[[7],[3, "item"]],[3, "open"]],[1, "navigator-box-show"],[1, ""]]]);Z([[6],[[7],[3, "item"]],[3, "pages"]]);Z([3, 'page']);Z([3, '*item']);Z([3, 'navigator']);Z([a, [3, 'pages/'],[[7],[3, "page"]],[3, '/'],[[7],[3, "page"]]]);Z([3, 'navigator-text']);Z([a, [[7],[3, "page"]]]);Z([3, 'navigator-arrow']);
  })(z);d_["./page/component/index.wxml"] = {};
  var m0=function(e,s,r,gg){
    var oC = _n("view");_r(oC, 'class', 0, e, s, gg);var oD = _n("view");_r(oD, 'class', 1, e, s, gg);var oE = _n("view");_r(oE, 'class', 2, e, s, gg);var oF = _o(3, e, s, gg);_(oE,oF);_(oD,oE);_(oC,oD);var oG = _n("view");_r(oG, 'class', 4, e, s, gg);var oH = _n("view");_r(oH, 'class', 5, e, s, gg);var oI = _v();var oJ = function(oN,oM,oL,gg){var oP = _n("view");_r(oP, 'class', 8, oN, oM, gg);var oQ = _m( "view", ["id", 7,"bindtap", 2,"class", 3], oN, oM, gg);var oR = _n("view");_r(oR, 'class', 11, oN, oM, gg);var oS = _o(12, oN, oM, gg);_(oR,oS);_(oQ,oR);var oT = _m( "image", ["class", 13,"src", 1], oN, oM, gg);_(oQ,oT);_(oP,oQ);var oU = _n("view");_r(oU, 'class', 15, oN, oM, gg);var oV = _n("view");_r(oV, 'class', 16, oN, oM, gg);var oW = _v();var oX = function(ob,oa,oZ,gg){var od = _m( "navigator", ["class", 20,"url", 1], ob, oa, gg);var oe = _n("view");_r(oe, 'class', 22, ob, oa, gg);var of = _o(23, ob, oa, gg);_(oe,of);_(od,oe);var og = _n("view");_r(og, 'class', 24, ob, oa, gg);_(od,og);_(oZ,od);return oZ;};_2(17, oX, oN, oM, gg, oW, "page", "index", '*item');_(oV,oW);_(oU,oV);_(oP,oU);_(oL,oP);return oL;};_2(6, oJ, e, s, gg, oI, "item", "index", '{{item.id}}');_(oH,oI);_(oG,oH);_(oC,oG);_(r,oC);
    return r;
  };
        e_["./page/component/index.wxml"]={f:m0,j:[],i:[],ti:[],ic:[]};
if(path&&e_[path]){
...
});require("page/component/index.js")@code-separator-line:["div","view","block","image","navigator"]