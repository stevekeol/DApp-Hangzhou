...
var z = [];
  (function(z){
    ...
    Z([3, 'page-foot']);Z([3, 'none']);Z([3, 'switchTab']);Z([3, '/page/component/index']);Z([3, 'icon-foot']);Z([3, '../../../../image/icon_foot.png']);Z([3, 'page-head']);Z([3, 'page-head-title']);Z([a, [[7],[3, "title"]]]);Z([3, 'page-head-line']);Z([[7],[3, "desc"]]);Z([3, 'page-head-desc']);Z([3, 'container']);Z([3, 'head']);Z([[8], "title", [1, "createSelectorQuery"]]);Z([3, 'getFields']);Z([3, 'page-body']);Z([3, 'weui-cells weui-cells_after-title']);Z([3, 'btn-area']);Z([3, 'submit']);Z([3, 'the-id']);Z([3, 'primary']);Z([3, '点击获取Button信息']);Z([3, 'foot']);
    ...
    p_[b]=true
    try{
      var o_h = _m( "navigator", ["class", 0,"hoverClass", 1,"openType", 1,"url", 2], e, s, gg);var oAi = _m( "image", ["class", 4,"src", 1], e, s, gg);_(o_h,oAi);_(r,o_h);
    }catch(err){
    p_[b]=false
    throw err
    }
  ...
  var m0=function(e,s,r,gg){
    ...
    p_[b]=true
    try{
      var oEi = _n("view");_r(oEi, 'class', 6, e, s, gg);var oFi = _n("view");_r(oFi, 'class', 7, e, s, gg);var oGi = _o(8, e, s, gg);_(oFi,oGi);_(oEi,oFi);var oHi = _n("view");_r(oHi, 'class', 9, e, s, gg);_(oEi,oHi);var oIi = _v();
      if (_o(10, e, s, gg)) {
        oIi.wxVkey = 1;var oJi = _n("view");_r(oJi, 'class', 11, e, s, gg);var oLi = _o(10, e, s, gg);_(oJi,oLi);_(oIi, oJi);
      } _(oEi,oIi);_(r,oEi);
    }catch(err){
    p_[b]=false
    throw err
  ...
  var m1=function(e,s,r,gg){
    ...
    return r;
        ...
        e_["./page/common/head.wxml"]={f:m1,j:[],i:[],ti:[],ic:[]};d_["./page/API/pages/create-selector-query/create-selector-query.wxml"] = {};
  var m2=function(e,s,r,gg){
    var oOi = e_["./page/API/pages/create-selector-query/create-selector-query.wxml"].i;_ai(oOi, '../../../common/head.wxml', e_, './page/API/pages/create-selector-query/create-selector-query.wxml', 0, 0);_ai(oOi, '../../../common/foot.wxml', e_, './page/API/pages/create-selector-query/create-selector-query.wxml', 0, 0);var oRi = _n("view");_r(oRi, 'class', 12, e, s, gg);var oSi = _v();
       var oTi = _o(13, e, s, gg);
       var oVi = _gd('./page/API/pages/create-selector-query/create-selector-query.wxml', oTi, e_, d_);
       if (oVi) {
         var oUi = _1(14,e,s,gg);
         oVi(oUi,oUi,oSi, gg);
       } else _w(oTi, './page/API/pages/create-selector-query/create-selector-query.wxml', 0, 0);_(oRi,oSi);var oWi = _m( "form", ["bindsubmit", 15,"class", 1], e, s, gg);var oXi = _n("view");_r(oXi, 'class', 17, e, s, gg);_(oWi,oXi);var oYi = _n("view");_r(oYi, 'class', 18, e, s, gg);var oZi = _m( "button", ["formType", 19,"id", 1,"type", 2], e, s, gg);var oai = _o(22, e, s, gg);_(oZi,oai);_(oYi,oZi);_(oWi,oYi);_(oRi,oWi);var obi = _v();
       var oci = _o(23, e, s, gg);
       var oei = _gd('./page/API/pages/create-selector-query/create-selector-query.wxml', oci, e_, d_);
       if (oei) {
         var odi = {};
         oei(odi,odi,obi, gg);
       } else _w(oci, './page/API/pages/create-selector-query/create-selector-query.wxml', 0, 0);_(oRi,obi);_(r,oRi);oOi.pop();oOi.pop();
    return r;
  };
        e_["./page/API/pages/create-selector-query/create-selector-query.wxml"]={f:m2,j:[],i:[],ti:["../../../common/head.wxml","../../../common/foot.wxml"],ic:[]};
if(path&&e_[path]){
...
});require("page/API/pages/create-selector-query/create-selector-query.js")@code-separator-line:["div","template","navigator","image","view","import","form","button"]