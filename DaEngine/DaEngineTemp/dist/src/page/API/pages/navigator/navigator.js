...
var z = [];
  (function(z){
    ...
    Z([3, 'page-foot']);Z([3, 'none']);Z([3, 'switchTab']);Z([3, '/page/component/index']);Z([3, 'icon-foot']);Z([3, '../../../../image/icon_foot.png']);Z([3, 'page-head']);Z([3, 'page-head-title']);Z([a, [[7],[3, "title"]]]);Z([3, 'page-head-line']);Z([[7],[3, "desc"]]);Z([3, 'page-head-desc']);Z([3, 'container']);Z([3, 'head']);Z([[8], "title", [1, "navigateTo/Back, redirectTo"]]);Z([3, 'page-body']);Z([3, 'btn-area']);Z([3, 'navigateTo']);Z([3, '跳转新页面']);Z([3, 'navigateBack']);Z([3, '返回上一页']);Z([3, 'redirectTo']);Z([3, '在当前页面打开']);Z([3, 'foot']);
...
if(typeof(window.__webview_engine_version__)=='undefined'||window.__webview_engine_version__+1e-6<0.01+1e-6){return _ev(root);}}catch(err){console.log(err)}return root;}}}@code-separator-line:@code-separator-line:__wxRoute = "page/API/pages/navigator/navigator";__wxRouteBegin = true;
define("page/API/pages/navigator/navigator.js", function(require, module, exports, window,document,frames,self,location,navigator,localStorage,history,Caches,screen,alert,confirm,prompt,fetch,XMLHttpRequest,WebSocket,webkit,WeixinJSCore,ServiceJSBridge,Reporter){
'use strict';
...
});require("page/API/pages/navigator/navigator.js")@code-separator-line:["div","template","navigator","image","view","import","button"]