...
var z = [];
  (function(z){
    ...
    Z([3, 'page-foot']);Z([3, 'none']);Z([3, 'switchTab']);Z([3, '/page/component/index']);Z([3, 'icon-foot']);Z([3, '../../../../image/icon_foot.png']);Z([3, 'page-head']);Z([3, 'page-head-title']);Z([a, [[7],[3, "title"]]]);Z([3, 'page-head-line']);Z([[7],[3, "desc"]]);Z([3, 'page-head-desc']);Z([3, 'container']);Z([3, 'head']);Z([[8], "title", [1, "templateMessage"]]);Z([3, 'submitForm']);Z([3, 'page-body']);Z([3, 'true']);Z([3, 'weui-cells__title']);Z([3, '点击提交，发送示例模板消息']);Z([3, 'weui-cells weui-cells_after-title']);Z([3, 'weui-cell weui-cell_input']);Z([3, 'weui-cell__hd']);Z([3, 'weui-label']);Z([3, '购买地点']);Z([3, 'weui-cell__bd']);Z([3, 'weui-input']);Z([1, true]);Z([3, 'address']);Z([3, 'text']);Z([[6],[[7],[3, "formData"]],[3, "address"]]);Z([3, '购买时间']);Z([3, 'time']);Z([[6],[[7],[3, "formData"]],[3, "time"]]);Z([3, '物品名称']);Z([3, 'name']);Z([[6],[[7],[3, "formData"]],[3, "name"]]);Z([3, '交易单号']);Z([3, 'serial']);Z([[6],[[7],[3, "formData"]],[3, "serial"]]);Z([3, 'btn-area']);Z([3, 'submit']);Z([[7],[3, "loading"]]);Z([3, '40']);Z([3, 'primary']);Z([3, '点我提交']);Z([3, 'foot']);
    ...
    p_[b]=true
    try{
      var oRc = _m( "navigator", ["class", 0,"hoverClass", 1,"openType", 1,"url", 2], e, s, gg);var oSc = _m( "image", ["class", 4,"src", 1], e, s, gg);_(oRc,oSc);_(r,oRc);
    }catch(err){
    p_[b]=false
    throw err
    }
  ...
  var m0=function(e,s,r,gg){
    ...
    p_[b]=true
    try{
      var oWc = _n("view");_r(oWc, 'class', 6, e, s, gg);var oXc = _n("view");_r(oXc, 'class', 7, e, s, gg);var oYc = _o(8, e, s, gg);_(oXc,oYc);_(oWc,oXc);var oZc = _n("view");_r(oZc, 'class', 9, e, s, gg);_(oWc,oZc);var oac = _v();
      if (_o(10, e, s, gg)) {
        oac.wxVkey = 1;var obc = _n("view");_r(obc, 'class', 11, e, s, gg);var odc = _o(10, e, s, gg);_(obc,odc);_(oac, obc);
      } _(oWc,oac);_(r,oWc);
    }catch(err){
    p_[b]=false
    throw err
  ...
  var m1=function(e,s,r,gg){
    ...
    return r;
        ...
        e_["./page/common/head.wxml"]={f:m1,j:[],i:[],ti:[],ic:[]};d_["./page/API/pages/template-message/template-message.wxml"] = {};
  var m2=function(e,s,r,gg){
    var ogc = e_["./page/API/pages/template-message/template-message.wxml"].i;_ai(ogc, '../../../common/head.wxml', e_, './page/API/pages/template-message/template-message.wxml', 0, 0);_ai(ogc, '../../../common/foot.wxml', e_, './page/API/pages/template-message/template-message.wxml', 0, 0);var ojc = _n("view");_r(ojc, 'class', 12, e, s, gg);var okc = _v();
       var olc = _o(13, e, s, gg);
       var onc = _gd('./page/API/pages/template-message/template-message.wxml', olc, e_, d_);
       if (onc) {
         var omc = _1(14,e,s,gg);
         onc(omc,omc,okc, gg);
       } else _w(olc, './page/API/pages/template-message/template-message.wxml', 0, 0);_(ojc,okc);var ooc = _m( "form", ["bindsubmit", 15,"class", 1,"reportSubmit", 2], e, s, gg);var opc = _n("view");_r(opc, 'class', 18, e, s, gg);var oqc = _o(19, e, s, gg);_(opc,oqc);_(ooc,opc);var orc = _n("view");_r(orc, 'class', 20, e, s, gg);var osc = _n("view");_r(osc, 'class', 21, e, s, gg);var otc = _n("view");_r(otc, 'class', 22, e, s, gg);var ouc = _n("view");_r(ouc, 'class', 23, e, s, gg);var ovc = _o(24, e, s, gg);_(ouc,ovc);_(otc,ouc);_(osc,otc);var owc = _n("view");_r(owc, 'class', 25, e, s, gg);var oxc = _m( "input", ["class", 26,"disabled", 1,"name", 2,"type", 3,"value", 4], e, s, gg);_(owc,oxc);_(osc,owc);_(orc,osc);var oyc = _n("view");_r(oyc, 'class', 21, e, s, gg);var ozc = _n("view");_r(ozc, 'class', 22, e, s, gg);var o_c = _n("view");_r(o_c, 'class', 23, e, s, gg);var oAd = _o(31, e, s, gg);_(o_c,oAd);_(ozc,o_c);_(oyc,ozc);var oBd = _n("view");_r(oBd, 'class', 25, e, s, gg);var oCd = _m( "input", ["class", 26,"disabled", 1,"type", 3,"name", 6,"value", 7], e, s, gg);_(oBd,oCd);_(oyc,oBd);_(orc,oyc);var oDd = _n("view");_r(oDd, 'class', 21, e, s, gg);var oEd = _n("view");_r(oEd, 'class', 22, e, s, gg);var oFd = _n("view");_r(oFd, 'class', 23, e, s, gg);var oGd = _o(34, e, s, gg);_(oFd,oGd);_(oEd,oFd);_(oDd,oEd);var oHd = _n("view");_r(oHd, 'class', 25, e, s, gg);var oId = _m( "input", ["class", 26,"disabled", 1,"type", 3,"name", 9,"value", 10], e, s, gg);_(oHd,oId);_(oDd,oHd);_(orc,oDd);var oJd = _n("view");_r(oJd, 'class', 21, e, s, gg);var oKd = _n("view");_r(oKd, 'class', 22, e, s, gg);var oLd = _n("view");_r(oLd, 'class', 23, e, s, gg);var oMd = _o(37, e, s, gg);_(oLd,oMd);_(oKd,oLd);_(oJd,oKd);var oNd = _n("view");_r(oNd, 'class', 25, e, s, gg);var oOd = _m( "input", ["class", 26,"disabled", 1,"type", 3,"name", 12,"value", 13], e, s, gg);_(oNd,oOd);_(oJd,oNd);_(orc,oJd);_(ooc,orc);var oPd = _n("view");_r(oPd, 'class', 40, e, s, gg);var oQd = _m( "button", ["formType", 41,"loading", 1,"size", 2,"type", 3], e, s, gg);var oRd = _o(45, e, s, gg);_(oQd,oRd);_(oPd,oQd);_(ooc,oPd);_(ojc,ooc);var oSd = _v();
       var oTd = _o(46, e, s, gg);
       var oVd = _gd('./page/API/pages/template-message/template-message.wxml', oTd, e_, d_);
       if (oVd) {
         var oUd = {};
         oVd(oUd,oUd,oSd, gg);
       } else _w(oTd, './page/API/pages/template-message/template-message.wxml', 0, 0);_(ojc,oSd);_(r,ojc);ogc.pop();ogc.pop();
    return r;
  };
        e_["./page/API/pages/template-message/template-message.wxml"]={f:m2,j:[],i:[],ti:["../../../common/head.wxml","../../../common/foot.wxml"],ic:[]};
if(path&&e_[path]){
...
});require("page/API/pages/template-message/template-message.js")@code-separator-line:["div","template","navigator","image","view","import","form","input","button"]