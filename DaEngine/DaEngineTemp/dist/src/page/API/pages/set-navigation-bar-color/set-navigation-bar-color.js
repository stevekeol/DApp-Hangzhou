...
var z = [];
  (function(z){
    ...
    Z([3, 'page-foot']);Z([3, 'none']);Z([3, 'switchTab']);Z([3, '/page/component/index']);Z([3, 'icon-foot']);Z([3, '../../../../image/icon_foot.png']);Z([3, 'page-head']);Z([3, 'page-head-title']);Z([a, [[7],[3, "title"]]]);Z([3, 'page-head-line']);Z([[7],[3, "desc"]]);Z([3, 'page-head-desc']);Z([3, 'container']);Z([3, 'head']);Z([[8], "title", [1, "setNaivgationBarColor"]]);Z([3, 'setNaivgationBarColor']);Z([3, 'page-body']);Z([3, 'weui-cells weui-cells_after-color']);Z([3, 'weui-cell weui-cell_input']);Z([3, 'weui-cell__hd']);Z([3, 'weui-label']);Z([3, '背景色']);Z([3, 'weui-cell__bd']);Z([3, 'weui-input']);Z([3, 'backgroundColor']);Z([3, '#c4d7e6']);Z([3, 'text']);Z([3, '文字颜色']);Z([3, 'frontColor']);Z([3, '#000000 or #ffffff']);Z([3, 'btn-area']);Z([3, 'submit']);Z([3, 'primary']);Z([3, '设置']);Z([3, 'foot']);
...
});require("page/API/pages/set-navigation-bar-color/set-navigation-bar-color.js")@code-separator-line:["div","template","navigator","image","view","import","form","input","button"]