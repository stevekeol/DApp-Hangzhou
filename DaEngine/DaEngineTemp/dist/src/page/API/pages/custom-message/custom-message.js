...
var z = [];
  (function(z){
    ...
    Z([3, 'page-foot']);Z([3, 'none']);Z([3, 'switchTab']);Z([3, '/page/component/index']);Z([3, 'icon-foot']);Z([3, '../../../../image/icon_foot.png']);Z([3, 'page-head']);Z([3, 'page-head-title']);Z([a, [[7],[3, "title"]]]);Z([3, 'page-head-line']);Z([[7],[3, "desc"]]);Z([3, 'page-head-desc']);Z([3, 'container']);Z([3, 'head']);Z([[8], "title", [1, "customMessage"]]);Z([3, 'page-body']);Z([3, 'page-body-wrapper']);Z([3, 'page-body-title']);Z([3, '\n        点击气泡icon打开客服消息界面\n      ']);Z([3, 'page-body-line']);Z([3, 'weapp']);Z([3, '40']);Z([3, 'foot']);
...
if(typeof(window.__webview_engine_version__)=='undefined'||window.__webview_engine_version__+1e-6<0.01+1e-6){return _ev(root);}}catch(err){console.log(err)}return root;}}}@code-separator-line:@code-separator-line:__wxRoute = "page/API/pages/custom-message/custom-message";__wxRouteBegin = true;
define("page/API/pages/custom-message/custom-message.js", function(require, module, exports, window,document,frames,self,location,navigator,localStorage,history,Caches,screen,alert,confirm,prompt,fetch,XMLHttpRequest,WebSocket,webkit,WeixinJSCore,ServiceJSBridge,Reporter){
"use strict";

Page({});
});require("page/API/pages/custom-message/custom-message.js")@code-separator-line:["div","template","navigator","image","view","import","text","contact-button"]