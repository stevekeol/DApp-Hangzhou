...
var z = [];
  (function(z){
    ...
    Z([3, 'page-foot']);Z([3, 'none']);Z([3, 'switchTab']);Z([3, '/page/component/index']);Z([3, 'icon-foot']);Z([3, '../../../../image/icon_foot.png']);Z([3, 'page-head']);Z([3, 'page-head-title']);Z([a, [[7],[3, "title"]]]);Z([3, 'page-head-line']);Z([[7],[3, "desc"]]);Z([3, 'page-head-desc']);Z([3, 'container']);Z([3, 'head']);Z([[8], "title", [1, "chooseVideo"]]);Z([3, 'page-body']);Z([3, 'page-section']);Z([3, 'weui-cells weui-cells_after-title']);Z([3, 'weui-cell weui-cell_input']);Z([3, 'weui-cell__hd']);Z([3, 'weui-label']);Z([3, '视频来源']);Z([3, 'weui-cell__bd']);Z([3, 'sourceTypeChange']);Z([[7],[3, "sourceType"]]);Z([[7],[3, "sourceTypeIndex"]]);Z([3, 'weui-input']);Z([a, [[6],[[7],[3, "sourceType"]],[[7],[3, "sourceTypeIndex"]]]]);Z([3, '摄像头']);Z([3, 'cameraChange']);Z([[7],[3, "camera"]]);Z([[7],[3, "cameraIndex"]]);Z([a, [[6],[[7],[3, "camera"]],[[7],[3, "cameraIndex"]]]]);Z([3, '拍摄长度']);Z([3, 'durationChange']);Z([[7],[3, "duration"]]);Z([[7],[3, "durationIndex"]]);Z([a, [[6],[[7],[3, "duration"]],[[7],[3, "durationIndex"]]]]);Z([3, 'page-body-info']);Z([[2, "==="], [[7],[3, "src"]], [1, ""]]);Z([3, 'chooseVideo']);Z([3, 'image-plus image-plus-nb']);Z([3, 'image-plus-horizontal']);Z([3, 'image-plus-vertical']);Z([3, 'image-plus-text']);Z([3, '添加视频']);Z([[2, "!="], [[7],[3, "src"]], [1, ""]]);Z([3, 'video']);Z([[7],[3, "src"]]);
    ...
    p_[b]=true
    try{
      var ouy = _m( "navigator", ["class", 0,"hoverClass", 1,"openType", 1,"url", 2], e, s, gg);var ovy = _m( "image", ["class", 4,"src", 1], e, s, gg);_(ouy,ovy);_(r,ouy);
    }catch(err){
    p_[b]=false
    throw err
    }
  ...
  var m0=function(e,s,r,gg){
    ...
    p_[b]=true
    try{
      var ozy = _n("view");_r(ozy, 'class', 6, e, s, gg);var o_y = _n("view");_r(o_y, 'class', 7, e, s, gg);var oAz = _o(8, e, s, gg);_(o_y,oAz);_(ozy,o_y);var oBz = _n("view");_r(oBz, 'class', 9, e, s, gg);_(ozy,oBz);var oCz = _v();
      if (_o(10, e, s, gg)) {
        oCz.wxVkey = 1;var oDz = _n("view");_r(oDz, 'class', 11, e, s, gg);var oFz = _o(10, e, s, gg);_(oDz,oFz);_(oCz, oDz);
      } _(ozy,oCz);_(r,ozy);
    }catch(err){
    p_[b]=false
    throw err
  ...
  var m1=function(e,s,r,gg){
    ...
    return r;
        ...
        e_["./page/common/head.wxml"]={f:m1,j:[],i:[],ti:[],ic:[]};d_["./page/API/pages/video/video.wxml"] = {};
  var m2=function(e,s,r,gg){
    var oIz = e_["./page/API/pages/video/video.wxml"].i;_ai(oIz, '../../../common/head.wxml', e_, './page/API/pages/video/video.wxml', 0, 0);_ai(oIz, '../../../common/foot.wxml', e_, './page/API/pages/video/video.wxml', 0, 0);var oLz = _n("view");_r(oLz, 'class', 12, e, s, gg);var oMz = _v();
       var oNz = _o(13, e, s, gg);
       var oPz = _gd('./page/API/pages/video/video.wxml', oNz, e_, d_);
       if (oPz) {
         var oOz = _1(14,e,s,gg);
         oPz(oOz,oOz,oMz, gg);
       } else _w(oNz, './page/API/pages/video/video.wxml', 0, 0);_(oLz,oMz);var oQz = _n("view");_r(oQz, 'class', 15, e, s, gg);var oRz = _n("view");_r(oRz, 'class', 16, e, s, gg);var oSz = _n("view");_r(oSz, 'class', 17, e, s, gg);var oTz = _n("view");_r(oTz, 'class', 18, e, s, gg);var oUz = _n("view");_r(oUz, 'class', 19, e, s, gg);var oVz = _n("view");_r(oVz, 'class', 20, e, s, gg);var oWz = _o(21, e, s, gg);_(oVz,oWz);_(oUz,oVz);_(oTz,oUz);var oXz = _n("view");_r(oXz, 'class', 22, e, s, gg);var oYz = _m( "picker", ["bindchange", 23,"range", 1,"value", 2], e, s, gg);var oZz = _n("view");_r(oZz, 'class', 26, e, s, gg);var oaz = _o(27, e, s, gg);_(oZz,oaz);_(oYz,oZz);_(oXz,oYz);_(oTz,oXz);_(oSz,oTz);var obz = _n("view");_r(obz, 'class', 18, e, s, gg);var ocz = _n("view");_r(ocz, 'class', 19, e, s, gg);var odz = _n("view");_r(odz, 'class', 20, e, s, gg);var oez = _o(28, e, s, gg);_(odz,oez);_(ocz,odz);_(obz,ocz);var ofz = _n("view");_r(ofz, 'class', 22, e, s, gg);var ogz = _m( "picker", ["bindchange", 29,"range", 1,"value", 2], e, s, gg);var ohz = _n("view");_r(ohz, 'class', 26, e, s, gg);var oiz = _o(32, e, s, gg);_(ohz,oiz);_(ogz,ohz);_(ofz,ogz);_(obz,ofz);_(oSz,obz);var ojz = _n("view");_r(ojz, 'class', 18, e, s, gg);var okz = _n("view");_r(okz, 'class', 19, e, s, gg);var olz = _n("view");_r(olz, 'class', 20, e, s, gg);var omz = _o(33, e, s, gg);_(olz,omz);_(okz,olz);_(ojz,okz);var onz = _n("view");_r(onz, 'class', 22, e, s, gg);var ooz = _m( "picker", ["bindchange", 34,"range", 1,"value", 2], e, s, gg);var opz = _n("view");_r(opz, 'class', 26, e, s, gg);var oqz = _o(37, e, s, gg);_(opz,oqz);_(ooz,opz);_(onz,ooz);_(ojz,onz);_(oSz,ojz);_(oRz,oSz);var orz = _n("view");_r(orz, 'class', 38, e, s, gg);var osz = _v();
      if (_o(39, e, s, gg)) {
        osz.wxVkey = 1;var ovz = _m( "view", ["bindtap", 40,"class", 1], e, s, gg);var owz = _n("view");_r(owz, 'class', 42, e, s, gg);_(ovz,owz);var oxz = _n("view");_r(oxz, 'class', 43, e, s, gg);_(ovz,oxz);_(osz,ovz);var oyz = _n("view");_r(oyz, 'class', 44, e, s, gg);var ozz = _o(45, e, s, gg);_(oyz,ozz);_(osz,oyz);
      } _(orz,osz);var o_z = _v();
      if (_o(46, e, s, gg)) {
        o_z.wxVkey = 1;var oC_ = _m( "video", ["class", 47,"src", 1], e, s, gg);_(o_z,oC_);
      } _(orz,o_z);_(oRz,orz);_(oQz,oRz);_(oLz,oQz);_(r,oLz);oIz.pop();oIz.pop();
    return r;
  };
        e_["./page/API/pages/video/video.wxml"]={f:m2,j:[],i:[],ti:["../../../common/head.wxml","../../../common/foot.wxml"],ic:[]};
if(path&&e_[path]){
...
});require("page/API/pages/video/video.js")@code-separator-line:["div","template","navigator","image","view","import","picker","block","video"]