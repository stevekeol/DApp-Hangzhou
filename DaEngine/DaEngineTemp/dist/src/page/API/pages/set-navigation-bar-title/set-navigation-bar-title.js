...
var z = [];
  (function(z){
    ...
    Z([3, 'page-foot']);Z([3, 'none']);Z([3, 'switchTab']);Z([3, '/page/component/index']);Z([3, 'icon-foot']);Z([3, '../../../../image/icon_foot.png']);Z([3, 'page-head']);Z([3, 'page-head-title']);Z([a, [[7],[3, "title"]]]);Z([3, 'page-head-line']);Z([[7],[3, "desc"]]);Z([3, 'page-head-desc']);Z([3, 'container']);Z([3, 'head']);Z([[8], "title", [1, "setNaivgationBarTitle"]]);Z([3, 'setNaivgationBarTitle']);Z([3, 'page-body']);Z([3, 'weui-cells weui-cells_after-title']);Z([3, 'weui-cell weui-cell_input']);Z([3, 'weui-cell__hd']);Z([3, 'weui-label']);Z([3, '页面标题']);Z([3, 'weui-cell__bd']);Z([3, 'weui-input']);Z([3, 'title']);Z([3, '请输入页面标题并点击设置即可']);Z([3, 'text']);Z([3, 'btn-area']);Z([3, 'submit']);Z([3, 'primary']);Z([3, '设置']);Z([3, 'foot']);
    ...
    p_[b]=true
    try{
      var oXd = _m( "navigator", ["class", 0,"hoverClass", 1,"openType", 1,"url", 2], e, s, gg);var oYd = _m( "image", ["class", 4,"src", 1], e, s, gg);_(oXd,oYd);_(r,oXd);
    }catch(err){
    p_[b]=false
    throw err
    }
  ...
  var m0=function(e,s,r,gg){
    ...
    p_[b]=true
    try{
      var ocd = _n("view");_r(ocd, 'class', 6, e, s, gg);var odd = _n("view");_r(odd, 'class', 7, e, s, gg);var oed = _o(8, e, s, gg);_(odd,oed);_(ocd,odd);var ofd = _n("view");_r(ofd, 'class', 9, e, s, gg);_(ocd,ofd);var ogd = _v();
      if (_o(10, e, s, gg)) {
        ogd.wxVkey = 1;var ohd = _n("view");_r(ohd, 'class', 11, e, s, gg);var ojd = _o(10, e, s, gg);_(ohd,ojd);_(ogd, ohd);
      } _(ocd,ogd);_(r,ocd);
    }catch(err){
    p_[b]=false
    throw err
  ...
  var m1=function(e,s,r,gg){
    ...
    return r;
        ...
        e_["./page/common/head.wxml"]={f:m1,j:[],i:[],ti:[],ic:[]};d_["./page/API/pages/set-navigation-bar-title/set-navigation-bar-title.wxml"] = {};
  var m2=function(e,s,r,gg){
    var omd = e_["./page/API/pages/set-navigation-bar-title/set-navigation-bar-title.wxml"].i;_ai(omd, '../../../common/head.wxml', e_, './page/API/pages/set-navigation-bar-title/set-navigation-bar-title.wxml', 0, 0);_ai(omd, '../../../common/foot.wxml', e_, './page/API/pages/set-navigation-bar-title/set-navigation-bar-title.wxml', 0, 0);var opd = _n("view");_r(opd, 'class', 12, e, s, gg);var oqd = _v();
       var ord = _o(13, e, s, gg);
       var otd = _gd('./page/API/pages/set-navigation-bar-title/set-navigation-bar-title.wxml', ord, e_, d_);
       if (otd) {
         var osd = _1(14,e,s,gg);
         otd(osd,osd,oqd, gg);
       } else _w(ord, './page/API/pages/set-navigation-bar-title/set-navigation-bar-title.wxml', 0, 0);_(opd,oqd);var oud = _m( "form", ["bindsubmit", 15,"class", 1], e, s, gg);var ovd = _n("view");_r(ovd, 'class', 17, e, s, gg);var owd = _n("view");_r(owd, 'class', 18, e, s, gg);var oxd = _n("view");_r(oxd, 'class', 19, e, s, gg);var oyd = _n("view");_r(oyd, 'class', 20, e, s, gg);var ozd = _o(21, e, s, gg);_(oyd,ozd);_(oxd,oyd);_(owd,oxd);var o_d = _n("view");_r(o_d, 'class', 22, e, s, gg);var oAe = _m( "input", ["class", 23,"name", 1,"placeholder", 2,"type", 3], e, s, gg);_(o_d,oAe);_(owd,o_d);_(ovd,owd);_(oud,ovd);var oBe = _n("view");_r(oBe, 'class', 27, e, s, gg);var oCe = _m( "button", ["formType", 28,"type", 1], e, s, gg);var oDe = _o(30, e, s, gg);_(oCe,oDe);_(oBe,oCe);_(oud,oBe);_(opd,oud);var oEe = _v();
       var oFe = _o(31, e, s, gg);
       var oHe = _gd('./page/API/pages/set-navigation-bar-title/set-navigation-bar-title.wxml', oFe, e_, d_);
       if (oHe) {
         var oGe = {};
         oHe(oGe,oGe,oEe, gg);
       } else _w(oFe, './page/API/pages/set-navigation-bar-title/set-navigation-bar-title.wxml', 0, 0);_(opd,oEe);_(r,opd);omd.pop();omd.pop();
    return r;
  };
        e_["./page/API/pages/set-navigation-bar-title/set-navigation-bar-title.wxml"]={f:m2,j:[],i:[],ti:["../../../common/head.wxml","../../../common/foot.wxml"],ic:[]};
if(path&&e_[path]){
...
});require("page/API/pages/set-navigation-bar-title/set-navigation-bar-title.js")@code-separator-line:["div","template","navigator","image","view","import","form","input","button"]