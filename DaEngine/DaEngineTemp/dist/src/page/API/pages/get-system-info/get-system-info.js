...
var z = [];
  (function(z){
    ...
    Z([3, 'page-foot']);Z([3, 'none']);Z([3, 'switchTab']);Z([3, '/page/component/index']);Z([3, 'icon-foot']);Z([3, '../../../../image/icon_foot.png']);Z([3, 'page-head']);Z([3, 'page-head-title']);Z([a, [[7],[3, "title"]]]);Z([3, 'page-head-line']);Z([[7],[3, "desc"]]);Z([3, 'page-head-desc']);Z([3, 'container']);Z([3, 'head']);Z([[8], "title", [1, "getSystemInfo"]]);Z([3, 'page-body']);Z([3, 'page-section']);Z([3, 'weui-cells weui-cells_after-title']);Z([3, 'weui-cell weui-cell_input']);Z([3, 'weui-cell__hd']);Z([3, 'weui-label']);Z([3, '手机型号']);Z([3, 'weui-cell__bd']);Z([3, 'weui-input']);Z([1, true]);Z([3, '未获取']);Z([3, 'text']);Z([[6],[[7],[3, "systemInfo"]],[3, "model"]]);Z([3, '微信语言']);Z([[6],[[7],[3, "systemInfo"]],[3, "language"]]);Z([3, '微信版本']);Z([[6],[[7],[3, "systemInfo"]],[3, "version"]]);Z([3, '屏幕宽度']);Z([[6],[[7],[3, "systemInfo"]],[3, "windowWidth"]]);Z([3, '屏幕高度']);Z([[6],[[7],[3, "systemInfo"]],[3, "windowHeight"]]);Z([3, 'DPI']);Z([[6],[[7],[3, "systemInfo"]],[3, "pixelRatio"]]);Z([3, '当前路由']);Z([[6],[[7],[3, "systemInfo"]],[3, "route"]]);Z([3, 'btn-area']);Z([3, 'getSystemInfo']);Z([3, 'primary']);Z([3, '获取手机系统信息']);Z([3, 'foot']);
    ...
    p_[b]=true
    try{
      var ofl = _m( "navigator", ["class", 0,"hoverClass", 1,"openType", 1,"url", 2], e, s, gg);var ogl = _m( "image", ["class", 4,"src", 1], e, s, gg);_(ofl,ogl);_(r,ofl);
    }catch(err){
    p_[b]=false
    throw err
    }
  ...
  var m0=function(e,s,r,gg){
    ...
    p_[b]=true
    try{
      var okl = _n("view");_r(okl, 'class', 6, e, s, gg);var oll = _n("view");_r(oll, 'class', 7, e, s, gg);var oml = _o(8, e, s, gg);_(oll,oml);_(okl,oll);var onl = _n("view");_r(onl, 'class', 9, e, s, gg);_(okl,onl);var ool = _v();
      if (_o(10, e, s, gg)) {
        ool.wxVkey = 1;var opl = _n("view");_r(opl, 'class', 11, e, s, gg);var orl = _o(10, e, s, gg);_(opl,orl);_(ool, opl);
      } _(okl,ool);_(r,okl);
    }catch(err){
    p_[b]=false
    throw err
  ...
  var m1=function(e,s,r,gg){
    ...
    return r;
        ...
        e_["./page/common/head.wxml"]={f:m1,j:[],i:[],ti:[],ic:[]};d_["./page/API/pages/get-system-info/get-system-info.wxml"] = {};
  var m2=function(e,s,r,gg){
    var oul = e_["./page/API/pages/get-system-info/get-system-info.wxml"].i;_ai(oul, '../../../common/head.wxml', e_, './page/API/pages/get-system-info/get-system-info.wxml', 0, 0);_ai(oul, '../../../common/foot.wxml', e_, './page/API/pages/get-system-info/get-system-info.wxml', 0, 0);var oxl = _n("view");_r(oxl, 'class', 12, e, s, gg);var oyl = _v();
       var ozl = _o(13, e, s, gg);
       var oAm = _gd('./page/API/pages/get-system-info/get-system-info.wxml', ozl, e_, d_);
       if (oAm) {
         var o_l = _1(14,e,s,gg);
         oAm(o_l,o_l,oyl, gg);
       } else _w(ozl, './page/API/pages/get-system-info/get-system-info.wxml', 0, 0);_(oxl,oyl);var oBm = _n("view");_r(oBm, 'class', 15, e, s, gg);var oCm = _n("view");_r(oCm, 'class', 16, e, s, gg);var oDm = _n("view");_r(oDm, 'class', 17, e, s, gg);var oEm = _n("view");_r(oEm, 'class', 18, e, s, gg);var oFm = _n("view");_r(oFm, 'class', 19, e, s, gg);var oGm = _n("view");_r(oGm, 'class', 20, e, s, gg);var oHm = _o(21, e, s, gg);_(oGm,oHm);_(oFm,oGm);_(oEm,oFm);var oIm = _n("view");_r(oIm, 'class', 22, e, s, gg);var oJm = _m( "input", ["class", 23,"disabled", 1,"placeholder", 2,"type", 3,"value", 4], e, s, gg);_(oIm,oJm);_(oEm,oIm);_(oDm,oEm);var oKm = _n("view");_r(oKm, 'class', 18, e, s, gg);var oLm = _n("view");_r(oLm, 'class', 19, e, s, gg);var oMm = _n("view");_r(oMm, 'class', 20, e, s, gg);var oNm = _o(28, e, s, gg);_(oMm,oNm);_(oLm,oMm);_(oKm,oLm);var oOm = _n("view");_r(oOm, 'class', 22, e, s, gg);var oPm = _m( "input", ["class", 23,"disabled", 1,"placeholder", 2,"type", 3,"value", 6], e, s, gg);_(oOm,oPm);_(oKm,oOm);_(oDm,oKm);var oQm = _n("view");_r(oQm, 'class', 18, e, s, gg);var oRm = _n("view");_r(oRm, 'class', 19, e, s, gg);var oSm = _n("view");_r(oSm, 'class', 20, e, s, gg);var oTm = _o(30, e, s, gg);_(oSm,oTm);_(oRm,oSm);_(oQm,oRm);var oUm = _n("view");_r(oUm, 'class', 22, e, s, gg);var oVm = _m( "input", ["class", 23,"disabled", 1,"placeholder", 2,"type", 3,"value", 8], e, s, gg);_(oUm,oVm);_(oQm,oUm);_(oDm,oQm);var oWm = _n("view");_r(oWm, 'class', 18, e, s, gg);var oXm = _n("view");_r(oXm, 'class', 19, e, s, gg);var oYm = _n("view");_r(oYm, 'class', 20, e, s, gg);var oZm = _o(32, e, s, gg);_(oYm,oZm);_(oXm,oYm);_(oWm,oXm);var oam = _n("view");_r(oam, 'class', 22, e, s, gg);var obm = _m( "input", ["class", 23,"disabled", 1,"placeholder", 2,"type", 3,"value", 10], e, s, gg);_(oam,obm);_(oWm,oam);_(oDm,oWm);var ocm = _n("view");_r(ocm, 'class', 18, e, s, gg);var odm = _n("view");_r(odm, 'class', 19, e, s, gg);var oem = _n("view");_r(oem, 'class', 20, e, s, gg);var ofm = _o(34, e, s, gg);_(oem,ofm);_(odm,oem);_(ocm,odm);var ogm = _n("view");_r(ogm, 'class', 22, e, s, gg);var ohm = _m( "input", ["class", 23,"disabled", 1,"placeholder", 2,"type", 3,"value", 12], e, s, gg);_(ogm,ohm);_(ocm,ogm);_(oDm,ocm);var oim = _n("view");_r(oim, 'class', 18, e, s, gg);var ojm = _n("view");_r(ojm, 'class', 19, e, s, gg);var okm = _n("view");_r(okm, 'class', 20, e, s, gg);var olm = _o(36, e, s, gg);_(okm,olm);_(ojm,okm);_(oim,ojm);var omm = _n("view");_r(omm, 'class', 22, e, s, gg);var onm = _m( "input", ["class", 23,"disabled", 1,"placeholder", 2,"type", 3,"value", 14], e, s, gg);_(omm,onm);_(oim,omm);_(oDm,oim);var oom = _n("view");_r(oom, 'class', 18, e, s, gg);var opm = _n("view");_r(opm, 'class', 19, e, s, gg);var oqm = _n("view");_r(oqm, 'class', 20, e, s, gg);var orm = _o(38, e, s, gg);_(oqm,orm);_(opm,oqm);_(oom,opm);var osm = _n("view");_r(osm, 'class', 22, e, s, gg);var otm = _m( "input", ["class", 23,"disabled", 1,"placeholder", 2,"type", 3,"value", 16], e, s, gg);_(osm,otm);_(oom,osm);_(oDm,oom);_(oCm,oDm);var oum = _n("view");_r(oum, 'class', 40, e, s, gg);var ovm = _m( "button", ["bindtap", 41,"type", 1], e, s, gg);var owm = _o(43, e, s, gg);_(ovm,owm);_(oum,ovm);_(oCm,oum);_(oBm,oCm);_(oxl,oBm);var oxm = _v();
       var oym = _o(44, e, s, gg);
       var o_m = _gd('./page/API/pages/get-system-info/get-system-info.wxml', oym, e_, d_);
       if (o_m) {
         var ozm = {};
         o_m(ozm,ozm,oxm, gg);
       } else _w(oym, './page/API/pages/get-system-info/get-system-info.wxml', 0, 0);_(oxl,oxm);_(r,oxl);oul.pop();oul.pop();
    return r;
  };
        e_["./page/API/pages/get-system-info/get-system-info.wxml"]={f:m2,j:[],i:[],ti:["../../../common/head.wxml","../../../common/foot.wxml"],ic:[]};
if(path&&e_[path]){
...
});require("page/API/pages/get-system-info/get-system-info.js")@code-separator-line:["div","template","navigator","image","view","import","input","button"]