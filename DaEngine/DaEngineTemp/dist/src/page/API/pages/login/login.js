...
var z = [];
  (function(z){
    ...
    Z([3, 'page-foot']);Z([3, 'none']);Z([3, 'switchTab']);Z([3, '/page/component/index']);Z([3, 'icon-foot']);Z([3, '../../../../image/icon_foot.png']);Z([3, 'page-head']);Z([3, 'page-head-title']);Z([a, [[7],[3, "title"]]]);Z([3, 'page-head-line']);Z([[7],[3, "desc"]]);Z([3, 'page-head-desc']);Z([3, 'container']);Z([3, 'head']);Z([[8], "title", [1, "Login"]]);Z([3, 'page-body']);Z([3, 'page-section']);Z([[2, "==="], [[7],[3, "hasLogin"]], [1, true]]);Z([3, 'page-body-title']);Z([3, '已登录']);Z([3, 'page-body-text']);Z([3, '每个微信号中仅需登录 1 次，后续每次进入页面即可根据微信 id 自动拉取用户信息']);Z([[2, "==="], [[7],[3, "hasLogin"]], [1, false]]);Z([3, '每个微信号中仅需登录一次']);Z([3, 'login']);Z([3, 'page-body-button']);Z([3, 'primary']);Z([3, '微信登录']);Z([3, 'foot']);
...
if(typeof(window.__webview_engine_version__)=='undefined'||window.__webview_engine_version__+1e-6<0.01+1e-6){return _ev(root);}}catch(err){console.log(err)}return root;}}}@code-separator-line:.page-section{margin-top:%%?200rpx?%%;display:flex;flex-direction:column;align-items:center;justify-content:center;width:100%;padding:0 %%?50rpx?%%;box-sizing:border-box}.page-body-title{font-size:%%?60rpx?%%;line-height:%%?200rpx?%%}.page-body-text{color:#bbb;font-size:%%?28rpx?%%;line-height:%%?40rpx?%%;margin:0 0 %%?100rpx?%% 0;text-align:center}.page-body-button{width:100%}@code-separator-line:__wxRoute = "page/API/pages/login/login";__wxRouteBegin = true;
define("page/API/pages/login/login.js", function(require, module, exports, window,document,frames,self,location,navigator,localStorage,history,Caches,screen,alert,confirm,prompt,fetch,XMLHttpRequest,WebSocket,webkit,WeixinJSCore,ServiceJSBridge,Reporter){
"use strict";
...
});require("page/API/pages/login/login.js")@code-separator-line:["div","template","navigator","image","view","import","block","text","button"]