...
var z = [];
  (function(z){
    ...
    Z([3, 'page-foot']);Z([3, 'none']);Z([3, 'switchTab']);Z([3, '/page/component/index']);Z([3, 'icon-foot']);Z([3, '../../../../image/icon_foot.png']);Z([3, 'page-head']);Z([3, 'page-head-title']);Z([a, [[7],[3, "title"]]]);Z([3, 'page-head-line']);Z([[7],[3, "desc"]]);Z([3, 'page-head-desc']);Z([3, 'container']);Z([3, 'head']);Z([[8], "title", [1, "scanCode"]]);Z([3, 'page-body']);Z([3, 'weui-cells__title']);Z([3, '扫码结果']);Z([3, 'weui-cells weui-cells_after-title']);Z([3, 'weui-cell']);Z([3, 'weui-cell__bd']);Z([a, [[7],[3, "result"]]]);Z([3, 'btn-area']);Z([3, 'scanCode']);Z([3, 'primary']);Z([3, '扫一扫']);Z([3, 'foot']);
    ...
    p_[b]=true
    try{
      var oYo = _m( "navigator", ["class", 0,"hoverClass", 1,"openType", 1,"url", 2], e, s, gg);var oZo = _m( "image", ["class", 4,"src", 1], e, s, gg);_(oYo,oZo);_(r,oYo);
    }catch(err){
    p_[b]=false
    throw err
    }
  ...
  var m0=function(e,s,r,gg){
    ...
    p_[b]=true
    try{
      var odo = _n("view");_r(odo, 'class', 6, e, s, gg);var oeo = _n("view");_r(oeo, 'class', 7, e, s, gg);var ofo = _o(8, e, s, gg);_(oeo,ofo);_(odo,oeo);var ogo = _n("view");_r(ogo, 'class', 9, e, s, gg);_(odo,ogo);var oho = _v();
      if (_o(10, e, s, gg)) {
        oho.wxVkey = 1;var oio = _n("view");_r(oio, 'class', 11, e, s, gg);var oko = _o(10, e, s, gg);_(oio,oko);_(oho, oio);
      } _(odo,oho);_(r,odo);
    }catch(err){
    p_[b]=false
    throw err
  ...
  var m1=function(e,s,r,gg){
    ...
    return r;
        ...
        e_["./page/common/head.wxml"]={f:m1,j:[],i:[],ti:[],ic:[]};d_["./page/API/pages/scan-code/scan-code.wxml"] = {};
  var m2=function(e,s,r,gg){
    var ono = e_["./page/API/pages/scan-code/scan-code.wxml"].i;_ai(ono, '../../../common/head.wxml', e_, './page/API/pages/scan-code/scan-code.wxml', 0, 0);_ai(ono, '../../../common/foot.wxml', e_, './page/API/pages/scan-code/scan-code.wxml', 0, 0);var oqo = _n("view");_r(oqo, 'class', 12, e, s, gg);var oro = _v();
       var oso = _o(13, e, s, gg);
       var ouo = _gd('./page/API/pages/scan-code/scan-code.wxml', oso, e_, d_);
       if (ouo) {
         var oto = _1(14,e,s,gg);
         ouo(oto,oto,oro, gg);
       } else _w(oso, './page/API/pages/scan-code/scan-code.wxml', 0, 0);_(oqo,oro);var ovo = _n("view");_r(ovo, 'class', 15, e, s, gg);var owo = _n("view");_r(owo, 'class', 16, e, s, gg);var oxo = _o(17, e, s, gg);_(owo,oxo);_(ovo,owo);var oyo = _n("view");_r(oyo, 'class', 18, e, s, gg);var ozo = _n("view");_r(ozo, 'class', 19, e, s, gg);var o_o = _n("view");_r(o_o, 'class', 20, e, s, gg);var oAp = _o(21, e, s, gg);_(o_o,oAp);_(ozo,o_o);_(oyo,ozo);_(ovo,oyo);var oBp = _n("view");_r(oBp, 'class', 22, e, s, gg);var oCp = _m( "button", ["bindtap", 23,"type", 1], e, s, gg);var oDp = _o(25, e, s, gg);_(oCp,oDp);_(oBp,oCp);_(ovo,oBp);_(oqo,ovo);var oEp = _v();
       var oFp = _o(26, e, s, gg);
       var oHp = _gd('./page/API/pages/scan-code/scan-code.wxml', oFp, e_, d_);
       if (oHp) {
         var oGp = {};
         oHp(oGp,oGp,oEp, gg);
       } else _w(oFp, './page/API/pages/scan-code/scan-code.wxml', 0, 0);_(oqo,oEp);_(r,oqo);ono.pop();ono.pop();
    return r;
  };
        e_["./page/API/pages/scan-code/scan-code.wxml"]={f:m2,j:[],i:[],ti:["../../../common/head.wxml","../../../common/foot.wxml"],ic:[]};
if(path&&e_[path]){
...
});require("page/API/pages/scan-code/scan-code.js")@code-separator-line:["div","template","navigator","image","view","import","button"]