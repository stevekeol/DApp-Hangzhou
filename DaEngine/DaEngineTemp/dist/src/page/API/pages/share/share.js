...
var z = [];
  (function(z){
    ...
    Z([3, 'page-foot']);Z([3, 'none']);Z([3, 'switchTab']);Z([3, '/page/component/index']);Z([3, 'icon-foot']);Z([3, '../../../../image/icon_foot.png']);Z([3, 'page-head']);Z([3, 'page-head-title']);Z([a, [[7],[3, "title"]]]);Z([3, 'page-head-line']);Z([[7],[3, "desc"]]);Z([3, 'page-head-desc']);Z([3, 'container']);Z([3, 'head']);Z([[8], "title", [1, "onShareAppMessage"]]);Z([3, 'page-body']);Z([3, 'weui-cells__title']);Z([3, '发送内容（以下字段可自由适配）']);Z([3, 'weui-cells weui-cells_after-title']);Z([3, 'weui-cell weui-cell_input']);Z([3, 'weui-cell__hd']);Z([3, 'weui-label']);Z([3, '标题']);Z([3, 'weui-cell__bd']);Z([3, 'weui-input']);Z([1, true]);Z([3, 'text']);Z([[6],[[7],[3, "shareData"]],[3, "title"]]);Z([3, '描述']);Z([[6],[[7],[3, "shareData"]],[3, "desc"]]);Z([3, '跳转页面']);Z([[6],[[7],[3, "shareData"]],[3, "path"]]);Z([3, 'weui-cells__tips']);Z([3, '点击右上角菜单分享给好友']);Z([3, 'foot']);
...
});require("page/API/pages/share/share.js")@code-separator-line:["div","template","navigator","image","view","import","input"]