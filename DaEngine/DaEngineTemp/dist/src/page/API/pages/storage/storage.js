...
var z = [];
  (function(z){
    ...
    Z([3, 'page-foot']);Z([3, 'none']);Z([3, 'switchTab']);Z([3, '/page/component/index']);Z([3, 'icon-foot']);Z([3, '../../../../image/icon_foot.png']);Z([3, 'page-head']);Z([3, 'page-head-title']);Z([a, [[7],[3, "title"]]]);Z([3, 'page-head-line']);Z([[7],[3, "desc"]]);Z([3, 'page-head-desc']);Z([3, 'container']);Z([3, 'head']);Z([[8], "title", [1, "get/set/clearStorage"]]);Z([3, 'page-body']);Z([3, 'page-section']);Z([3, 'weui-cells weui-cells_after-title']);Z([3, 'weui-cell weui-cell_input']);Z([3, 'weui-cell__hd']);Z([3, 'weui-label']);Z([3, 'key']);Z([3, 'weui-cell__bd']);Z([3, 'keyChange']);Z([3, 'weui-input']);Z([3, '请输入key']);Z([3, 'text']);Z([[7],[3, "key"]]);Z([3, 'value']);Z([3, 'dataChange']);Z([3, 'data']);Z([3, '请输入value']);Z([[7],[3, "data"]]);Z([3, 'btn-area']);Z([3, 'setStorage']);Z([3, 'primary']);Z([3, '存储数据']);Z([3, 'getStorage']);Z([3, '读取数据']);Z([3, 'clearStorage']);Z([3, '清理数据']);Z([3, 'confirm']);Z([[6],[[7],[3, "dialog"]],[3, "hidden"]]);Z([[6],[[7],[3, "dialog"]],[3, "title"]]);Z([a, [[6],[[7],[3, "dialog"]],[3, "content"]]]);Z([3, 'foot']);
...
});require("page/API/pages/storage/storage.js")@code-separator-line:["div","template","navigator","image","view","import","input","button","modal"]