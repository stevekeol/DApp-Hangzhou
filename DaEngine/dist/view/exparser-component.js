...
(function (glob) {
    ...
    WeixinJSBridge.subscribe('setKeyboardValue', function (event) {
        event &&
            event.data &&
            exparser.triggerEvent(document, 'setKeyboardValue', {
...
(function (win) {
    ...
    var triggerEvent = function (event, name, params) {
    ...
    }, distanceThreshold = 10, longtapGapTime = 350, wxScrollTimeLowestValue = 50, setTouches = function (event, change) {
        ...
        return event;
    }, isTouchstart = !1, oriTimeStamp = 0, curX = 0, curY = 0, curEvent = 0, longtapTimer = null, isCancletap = !1, canceltap = function (node) {
        for (; node; node = node.parentNode) {
            var element = node.__wxElement || node;
            if (element.__wxScrolling &&
        ...
        if (oriTimeStamp) {
            if (!(Math.abs(x - curX) < distanceThreshold &&
    ...
    win.addEventListener('touchend', function (event) {
        ...
        event.touches.length === 0 &&
            touchend(event, event.changedTouches[0].pageX, event.changedTouches[0].pageY);
    }, {
        capture: !0,
        passive: !1
    });
    ...
    var analyticsConfig = {}, readyAnalyticsReport = function (event) {
        ...
        for (var i = 0; i < analyticsConfig.data.length; i++) {
            ...
            if (curData.element === selector) {
                ...
                selector.indexOf('.') === 0 &&
                    (data.index = Array.prototype.indexOf.call(document.body.querySelectorAll(curData.element), ele));
...
window.exparser.registerAsyncComp = function (names, cb) {
    ...
    names
        ...
        .map(function (name) { return requireAsync(name); });
    ...
    function requireAsync(name) {
        switch (name) {
            case 'wx-map':
                ...
                import(/* webpackChunkName: "wx-map" */ './components/wx-map').then(checkState);
                break;
            case 'wx-canvas':
                import(/* webpackChunkName: "wx-canvas" */ './components/wx-canvas').then(checkState);
                break;
            case 'wx-picker-view':
                import(/* webpackChunkName: "wx-picker-view" */ './components/wx-picker-view').then(checkState);
                break;
            case 'wx-picker':
                import(/* webpackChunkName: "wx-picker" */ './components/wx-picker').then(checkState);
                break;
            case 'wx-picker-view-column':
                import(/* webpackChunkName: "wx-picker-view-column" */ './components/wx-picker-view-column').then(checkState);
                break;
            case 'wx-video':
                import(/* webpackChunkName: "wx-video" */ './components/wx-video').then(checkState);
                break;
            case 'wx-radio-group':
                import(/* webpackChunkName: "wx-radio-group" */ './components/wx-radio-group').then(checkState);
                break;
            case 'wx-swiper':
                import(/* webpackChunkName: "wx-swiper" */ './components/wx-swiper').then(checkState);
                break;
            case 'wx-modal':
                import(/* webpackChunkName: "wx-modal" */ './components/wx-modal').then(checkState);
                break;
            case 'wx-switch':
                import(/* webpackChunkName: "wx-switch" */ './components/wx-switch').then(checkState);
                break;
            case 'wx-toast':
                import(/* webpackChunkName: "wx-toast" */ './components/wx-toast').then(checkState);
                break;
            case 'wx-radio':
                import(/* webpackChunkName: "wx-radio" */ './components/wx-radio').then(checkState);
                break;
            case 'wx-scroll-view':
                import(/* webpackChunkName: "wx-scroll-view" */ './components/wx-scroll-view').then(checkState);
                break;
            case 'wx-textarea':
                import(/* webpackChunkName: "wx-textarea" */ './components/wx-textarea').then(checkState);
                break;
            case 'wx-input':
                import(/* webpackChunkName: "wx-input" */ './components/wx-input').then(checkState);
                break;
            case 'wx-contact-button':
                import(/* webpackChunkName: "wx-contact-button" */ './components/wx-contact-button').then(checkState);
                break;
            case 'wx-audio':
                import(/* webpackChunkName: "wx-audio" */ './components/wx-audio').then(checkState);
                break;
            case 'wx-form':
                import(/* webpackChunkName: "wx-form" */ './components/wx-form').then(checkState);
                break;
            case 'wx-slider':
                import(/* webpackChunkName: "wx-slider" */ './components/wx-slider').then(checkState);
                break;
            case 'wx-swiper-item':
                import(/* webpackChunkName: "wx-swiper-item" */ './components/wx-swiper-item').then(checkState);
                break;
            case 'wx-progress':
                import(/* webpackChunkName: "wx-progress" */ './components/wx-progress').then(checkState);
                break;
            case 'wx-action-sheet-cancel':
                import(/* webpackChunkName: "wx-action-sheet-cancel" */ './components/wx-action-sheet-cancel').then(checkState);
                break;
            case 'wx-action-sheet':
                import(/* webpackChunkName: "wx-action-sheet" */ './components/wx-action-sheet').then(checkState);
                break;
            case 'wx-action-sheet-item':
                import(/* webpackChunkName: "wx-action-sheet-item" */ './components/wx-action-sheet-item').then(checkState);
                break;
            case 'wx-template':
            case 'wx-div':
            case 'wx-import':
