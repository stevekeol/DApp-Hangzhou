...
var textParser = (function () {
    var parserCreator = (function () {
        ...
        creator.create = function (t, n) {
            ...
            i._cbs = n;
            var o = (i._stateTable = {}), r = (i._stateRecTable = {}), a = {}, s = {}, l = function (e, n, i, o, r) {
            ...
            for (c in t) {
                for (var d = t[c], u = (o[c] = {}), h = (r[c] = {}), p = (a[c] = {}), f = (s[c] = {}), A = 0; A < d.length; A++) {
                    var g = d[A], _ = g.states[0];
                    _ === c ? ((_ = g.states[1]), l(c, g, _, h, f)) : l(c, g, _, u, p);
                }
            }
            var v = null, w = function e(t, n, i) {
                if (v[t] !== 2) {
                    if (v[t] === 1) {
            ...
            var d = function (l, c, d) {
                ...
                for (var p = c ? 1 : 0; p < u.length; p++) {
                    ...
                    if (Object.prototype.hasOwnProperty.call(n, f)) {
                        ...
                        h.push(r.str[r.pos]), r.pos++;
                    else {
                        for (var A = r.str[r.pos], g = r.str.charCodeAt(r.pos), _ = 0; _ < f.length; _++) {
                            if (f[_ + 1] === '-' && f[_ + 2]) {
                                var v = f.charCodeAt(_), w = f.charCodeAt(_ + 2);
                                if (v <= g && g <= w)
                                    break;
                                _ += 2;
                            }
    ...
    var decodeEntities = function (text) {
        return text.replace(/&([a-zA-Z]*?);/g, function (match, p1) {
            if (entities.hasOwnProperty(p1) && entities[p1])
                return entities[p1];
            if (/^#[0-9]{1,4}$/.test(p1))
                return String.fromCharCode(p1.slice(1));
    ...
    var s = function (e) {
        var rootNode = { children: [] }, i = rootNode, o = [], r = null;
                ...
                if (void 0 === node.type || node.type === 'node' || node.type === '') {
                    if (typeof node.name === 'string' && node.name !== '') {
                        ...
                        if (nodeParser.rules.hasOwnProperty(r)) {
                            var a = nodeParser.rules[r], s = document.createElement(r);
                            if (s) {
                                if (typeof node.attrs === 'object') {
                                    for (var l in node.attrs) {
                                        var c = l.toLowerCase(), d = textParser.decodeEntities(node.attrs[l]);
                                        if (c === 'class') {
                                            var u = o
                    ...
                    node.type === 'text' &&
                        ...
                        node.text !== '' &&
                        i.appendChild(document.createTextNode(textParser.decodeEntities(node.text)));
                }
            }
        });
        return i;
...
window.exparser.registerElement({
    ...
    _nodesObserver: function (nodes) {
        if (!this._ready)
            return void (this._cachedVal = nodes);
